...
tr><td valign="top"><a href="https://github.com/eclipse-openj9/openj9/pull/6196">#6196</a></td>
<td valign="top">New <tt>-Xgc</tt> parameter related to concurrent kickoff calculation is added.</td>
<td valign="top">All versions</td>
<td valign="top">You can use the <tt>concurrentKickoffTenuringHeadroom</tt> parameter to add the required headroom on top of the automatic concurrent kickoff calculation to trigger the concurrent global GC cycle earlier than the GC heuristic computed kickoff point.</td>
</tr>
