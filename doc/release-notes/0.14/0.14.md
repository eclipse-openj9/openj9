...
<td valign="top">New Java stack (jstack) tool</td>
<td valign="top">OpenJDK8 and later (All platforms)</td>
...
<td valign="top">The tool can be used to query running Java processes. This tool is already available with OpenJDK 12. </td>
</tr>
