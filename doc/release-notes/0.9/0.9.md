...
[#244 ](https://github.com/eclipse/openj9/issues/244 ) testCrNocr in VmArgumentTests failed - java.lang.AssertionError: Target process failed test failure *(Lan Xia)*
<br/>[#366 ](https://github.com/eclipse/openj9/issues/366 ) cmdLineTest: cmdLineTester_jep178_staticLinking_SE90 failed due to cannot find `/lib/amd64/compressedrefs/testjep178_static` comp:test test failure *(Tianyu Zuo)*
<br/>[#480 ](https://github.com/eclipse/openj9/issues/480 ) j9vm.test.softmx.SoftmxRemoteTest.setUp server is not ready after 120 seconds bug comp:test test failure *(Peter Bain)*
<br/>[#1127](https://github.com/eclipse/openj9/issues/1127) jdk_io test error jdk8 test failure *(Shelley Lambert)*
<br/>[#1128](https://github.com/eclipse/openj9/issues/1128) jdk_lang test failures jdk8 prio:high test failure *(Shelley Lambert)*
<br/>[#1129](https://github.com/eclipse/openj9/issues/1129) jdk_net test failure jdk8 test failure *(Shelley Lambert)*
<br/>[#1130](https://github.com/eclipse/openj9/issues/1130) jdk_nio test failures jdk8 test failure *(Shelley Lambert)*
<br/>[#1131](https://github.com/eclipse/openj9/issues/1131) jdk_util test failures jdk8 test failure *(Shelley Lambert)*
<br/>[#1144](https://github.com/eclipse/openj9/issues/1144) jdk_rmi test failures jdk8 test failure *(Shelley Lambert)*
<br/>[#1151](https://github.com/eclipse/openj9/issues/1151) ARM Hang while compiling test/Jsr292 test failure *(James Kingdon)*
<br/>[#1203](https://github.com/eclipse/openj9/issues/1203) TestUTF8 fails with assertion Unsafe_copySwapMemory0 is unimplemented comp:vm test failure *(James Kingdon)*
<br/>[#1205](https://github.com/eclipse/openj9/issues/1205) ARM sigbus from initialiseAOTRelocationHeader comp:jit test failure *(James Kingdon)*
<br/>[#1209](https://github.com/eclipse/openj9/issues/1209) ARM Assertion in J9TransformUtil.cpp comp:jit test failure *(James Kingdon)*
<br/>[#1212](https://github.com/eclipse/openj9/issues/1212) ARM JVM_GetVmArguments not implemented comp:vm test failure *(James Kingdon)* <!-- following are newer -->
<br/>[#1430](https://github.com/eclipse/openj9/issues/1430) openjdk9-openj9 jdk_lang test failures comp:test jdk9 test failure *(Sophia Guo)*
<br/>[#1431](https://github.com/eclipse/openj9/issues/1431) openjdk9-openj9 jdk_io test failures test failure *(Sophia Guo)*
<br/>[#1432](https://github.com/eclipse/openj9/issues/1432) openjdk9-openj9 jdk_net test failures test failure *(Sophia Guo)*
<br/>[#1433](https://github.com/eclipse/openj9/issues/1433) openjdk9-openj9 jdk_nio test failures test failure *(Sophia Guo)*
<br/>[#1434](https://github.com/eclipse/openj9/issues/1434) openjdk9-openj9 jdk_util test failures test failure *(Sophia Guo)*
<br/>[#1435](https://github.com/eclipse/openj9/issues/1435) openjdk9-openj9 jdk_rmi test failures test failure *(Sophia Guo)*
<br/>[#1566](https://github.com/eclipse/openj9/issues/1566) java.lang.IllegalArgumentException: argument type mismatch received in JMX Bean test in Hotspot, but none in OpenJ9 question test failure *(Mesbah Alam)*
<br/>[#1626](https://github.com/eclipse/openj9/issues/1626) JDK10 JLM_Tests_interface FAILED comp:test jdk10 test failure *(Renfei Wang)*
<br/>[#1765](https://github.com/eclipse/openj9/issues/1765) Annotation testing failures test failure *(Joe deKoning)*
<br/>[#1796](https://github.com/eclipse/openj9/issues/1796) ARM: Hang in SharedClassesSysVTesting_0 test failure *(James Kingdon)*
<br/>[#1814](https://github.com/eclipse/openj9/issues/1814) SCCommandLineOptionTests/SCURLClassLoaderNPTest failed on JDK10-win_x86-64_cmprssptrs comp:test jdk10 test failure *(Renfei Wang)*
<br/>[#2009](https://github.com/eclipse/openj9/issues/2009) cmdLineTester_jvmtitests_hcr_OSRG ta001 extended functional failure zLinux, pLinux, AIX, Win prio:high test failure *(Peter Shipton)*
<br/>[#2013](https://github.com/eclipse/openj9/issues/2013) cmdLineTester_jvmtitests_2 functional sanity fer003 gfp test failure *(Peter Shipton)*
<br/>[#2019](https://github.com/eclipse/openj9/issues/2019) Test-Extended-JDK8-linux_ppc-64_cmprssptrs_le TestAttachErrorHandling OOM in attach API test failure *(Peter Shipton)*
<br/>[#2065](https://github.com/eclipse/openj9/issues/2065) Windows cmdLineTest_J9test sanity failure due to timeout testing -Xpreloaduser32 -Xprotectcontiguous test failure *(Peter Shipton)*
<br/>[#2114](https://github.com/eclipse/openj9/issues/2114) cmdLineTester_jvmtitests_hcr_3 functional sanity rc010 gpf test failure *(Peter Shipton)*
<br/>[#2129](https://github.com/eclipse/openj9/issues/2129) Windows JDK8 jvmti tests failed with "NPT ERROR: Cannot open library" test failure *(Liqun Liu)*
<br/>[#2139](https://github.com/eclipse/openj9/issues/2139) Test-Sanity-JDK8-linux_ppc-64 cmdLineTester_decompilationTests_1 decomp002 assert prio:high test failure *(Peter Shipton)*
<br/>[#2141](https://github.com/eclipse/openj9/issues/2141) Test-Extended-JDK8-aix_ppc-64_cmprssptrs startupShutdownRobustness IOException: Error deleting test failure *(Peter Shipton)*
<br/>[#2213](https://github.com/eclipse/openj9/issues/2213) Test-Extended-JDK8-win_x86 testOpenJ9DiagnosticsMXBean_0 hangs comp:test test failure *(Peter Shipton)*
