...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ztpf_390-64_cmprssptrs">
	<name>ZTPF S390 64bit Compressed Pointers Builder</name>
	...
	<properties>
		...
		<property name="graph_label.java70_27" value="ptz64cmprssptrs70_27"/>
		<property name="graph_label.java8" value="ptz64cmprssptrs80"/>
		<property name="graph_label.java9" value="ptz64cmprssptrs90"/>
		<property name="graph_label.osid" value="tpf"/>
		...
		<property name="j2seTags" value="ptz64cmprssptrs60,j9vmtz64cmprssptrs24"/>
		...
		<property name="javatestPlatform" value="linux_ztpf_390-64_cmprssptrs"/>
		...
		<property name="maketpf_build" value="commit"/>
		...
		<property name="uma_make_cmd_dll_ld" value="tpf-gcc"/>
