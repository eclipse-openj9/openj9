...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_x86-64_cmprssptrs_sp">
	<name>Linux Hammer Compressed Pointers Spectre</name>
	...
	<properties>
		...
		<property name="SE6_package" value="xas64"/>
		...
		<property name="graph_label.java8" value="pxas64cmprssptrs80"/>
		<property name="graph_label.java9" value="pxas64cmprssptrs90"/>
		...
		<property name="javatestPlatform" value="linux_x86-64_cr_sp"/>
		...
		<property name="main_shortname" value="xas64"/>
