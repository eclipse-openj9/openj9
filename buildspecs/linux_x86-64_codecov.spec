...
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_x86-64_codecov">
	...
	<properties>
		...
		<property name="graph_label.java5" value="j9vmxa6424_codecov"/>
		<property name="graph_label.java6" value="pxa6460_codecov"/>
		<property name="graph_label.java60_26" value="pxa6460_26_codecov"/>
		<property name="graph_label.java6_rebuilt_extension" value="zip"/>
		<property name="graph_label.java7" value="pxa6470_codecov"/>
		<property name="graph_label.java70_27" value="pxa6470_27_codecov"/>
		<property name="graph_label.java7_raw" value="jdk7-linux-x64_codecov"/>
		<property name="graph_label.java8" value="pxa6480_codecov"/>
		<property name="graph_label.java9" value="pxa6490_codecov"/>
		...
		<property name="j2seTags" value="pxa6460_codecov,j9vmxa6424_codecov"/>
		<property name="j9BuildName" value="linux_x86-64_codecov"/>
		...
		<property name="javatestPlatform" value="linux_x86-64_codecov"/>
