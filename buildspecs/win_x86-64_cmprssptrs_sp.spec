...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="win_x86-64_cmprssptrs_sp">
	<name>Win64 Hammer Compressed Pointers Spectre</name>
	...
	<properties>
		...
		<property name="SE6_package" value="was64"/>
		...
		<property name="graph_label.java8" value="pwas64cmprssptrs80"/>
		<property name="graph_label.java9" value="pwas64cmprssptrs90"/>
		...
		<property name="javatestPlatform" value="win_x86-64_cr_sp"/>
		...
		<property name="main_shortname" value="was64"/>
