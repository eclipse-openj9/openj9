...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_ppc-64_cmprssptrs_le_sp">
	<name>Linux PPC LE 64bit Compressed Pointers Spectre</name>
	...
	<properties>
		...
		<property name="SE6_package" value="xps64le"/>
		<property name="aotTarget" value="ppc-linux"/>
		<property name="complianceTestingJavaLibraryPath" value="linux_ppcle-64_sp"/>
		...
		<property name="graph_label.java8" value="pxps64lecmprssptrs80"/>
		<property name="graph_label.java9" value="pxps64lecmprssptrs90"/>
		...
		<property name="javatestPlatform" value="linux_ppcle-64_cr_sp"/>
		...
		<property name="main_shortname" value="xls64"/>
