...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="aix_ppc-64_cmprssptrs_sp">
	<name>AIX64 Compressed Pointers Spectre</name>
	...
	<properties>
		...
		<property name="SE6_package" value="aps64"/>
		...
		<property name="graph_label.java8" value="paps64cmprssptrs80"/>
		<property name="graph_label.java9" value="paps64cmprssptrs90"/>
		...
		<property name="javatestPlatform" value="aix_ppc-64_cr_sp"/>
		...
		<property name="main_shortname" value="aps64"/>
