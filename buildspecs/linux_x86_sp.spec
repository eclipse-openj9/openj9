...
-->
<spec xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="http://www.ibm.com/j9/builder/spec" xsi:schemaLocation="http://www.ibm.com/j9/builder/spec spec-v1.xsd" id="linux_x86_sp">
	<name>Linux IA32 Spectre</name>
	...
	<properties>
		...
		<property name="SE6_package" value="xis32"/>
		...
		<property name="graph_label.java8" value="pxis3280"/>
		<property name="graph_label.java8_raw" value="jdk8-linux-i586"/>
		<property name="graph_label.java9" value="pxis3290"/>
		...
		<property name="javatestPlatform" value="linux_x86-32_sp"/>
		...
		<property name="main_shortname" value="xis32"/>
		...
		<property name="uma_sp_cflags" value="-mindirect-branch=thunk -mfunction-return=thunk -mindirect-branch-register"/>
