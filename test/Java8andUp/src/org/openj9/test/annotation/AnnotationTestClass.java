...
@ClassAnnotation(value = "ClassAnnotation")
public class AnnotationTestClass {
	@ValueAnnotation(
			...
			annotationArrayValue = {
					@ClassAnnotation(value = "ClassAnnotation1"),
					@ClassAnnotation(value = "ClassAnnotation2") }) @FieldAnnotation(
							value = "FieldAnnotation") public String field;
	...
	public AnnotationTestClass(@ParameterAnnotation(value = "ParameterAnnotation") @Deprecated() String param1,
			@ParameterAnnotation(value = "ParameterAnnotation") String param2) {
	}

	public AnnotationTestClass(String param) {
	}
	...
	public void method(@ParameterAnnotation(value = "ParameterAnnotation") @Deprecated() String param1,
			@ParameterAnnotation(value = "ParameterAnnotation") String param2) {
	}
