...
public class SoftReferenceAgingTestRunner extends Runner {

	public SoftReferenceAgingTestRunner(String className, String exeName, String bootClassPath, String userClassPath, String javaVersion) {
