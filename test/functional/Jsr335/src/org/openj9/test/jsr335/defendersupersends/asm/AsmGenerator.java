 ...
 *
 */
public interface AsmGenerator extends Opcodes {
	/**
	 * Generate the classfile bytes
	 * @return The classfile bytes
	 */
	public byte[] getClassData();
	
	/**
	 * Get the java-style name (ie java.lang.Object)
	 * @return The java-style name
	 */
	public String name();
	
	/**
	 * Return the asm-style name (ie java/lang/Object)
	 * @return The asm-style name
	 */
