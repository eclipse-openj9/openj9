...
public class Test {
            ...
            for (i13 = 5; i13 > i12; i13--) {
                ...
                Test.lArrFld[i13 + 1] = i13;
                {
                    ...
                    try {
                        ...
                        double[] ax$11 = new double[]{ 0.37105866940889287, 0.43594160670936655 };
                        double[] ax$12 = new double[]{ 0.9953157457687588, 0.01769849677830604, 0.16162351829557753, 0.876082018046841, 0.3261026708196796, 0.17120792447053623 };
                        double[] ax$14 = new double[1];
                        boolean ax$4 = false;
                        for (int ax$3 = -991; ax$3 < (-991 + 5984); ax$3 += 1) {
                            Test.AxOutputRedirectionHelper.redirect();
                            try {
                                ByteBuffer ax$7 = ByteBuffer.allocate(8);
                                ByteArrayOutputStream ax$8 = new ByteArrayOutputStream();
                                for (int ax$9 = 0; ax$9 < i12; ax$9++) {
                                    ax$7.putDouble(0, Math.random());
                                    ax$8.write(ax$7.array(), 0, 8);
                                }
                                ax$5 = ax$8.toByteArray();
    ...
    public static void vMeth(long l, int i) {
        ...
        long l5 = -1011547144L;
        {
            try {
                boolean ax$1 = true;
                for (int ax$0 = -593; ax$0 < (-593 + 5555); ax$0 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        ax$1 = true;
