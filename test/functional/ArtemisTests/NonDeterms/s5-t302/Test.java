...
public class Test {
    ...
    public static void vMeth(short s, long l1, byte by) {
        ...
        int i11 = -8;
        {
            final int ax$41 = Test.iFld;
            final int ax$42 = i11;
            try {
                int[] ax$37 = new int[]{ -705343412, -235289599, 1572622314, 2086429519, -1658804548 };
                for (int ax$35 = -563; ax$35 < (-563 + 5414); ax$35 += 1) {
    ...
    public static int iMeth(int i1, double d1, long l) {
        ...
        l >>>= (l - (i1 + i1)) ^ ((9 + (i1 * i1)) + (i1++));
        {
            ...
            final int ax$34 = i19;
            try {
                int[] ax$21 = new int[20];
                long[] ax$25 = new long[60];
                for (int ax$20 = -26; ax$20 < (-26 + 6052); ax$20 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        i18 += ax$21[i19 - 4];
                    ...
                    Test.AxOutputRedirectionHelper.recover();
                    Test.ax$18 = true;
                    lMeth(-702173575, -1991633990, 178370508);
                    Test.ax$18 = false;
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        Class ax$26 = Class.forName("Test6800154");
                        URLClassLoader ax$27 = ((URLClassLoader) (ax$26.getClassLoader()));
                        for (int ax$28 = 0; ax$28 < ax$25.length; ax$28++) {
                            System.setProperty("divisor", "" + ax$25[ax$28]);
                            ClassLoader ax$29 = new URLClassLoader(ax$27.getURLs(), ax$27.getParent());
                            Class ax$30 = ax$29.loadClass("Test6800154");
                            Runnable ax$31 = ((Runnable) (ax$30.newInstance()));
                            ax$31.run();
                        }
    ...
    public void mainTest(String[] strArr1) {
        ...
        i = ((int) (Test.instanceCount = ((long) (Test.instanceCount -= ((long) (d * Test.instanceCount))))));
        {
            ...
            try {
                int[] ax$9 = new int[]{ 7 };
                int[] ax$12 = new int[]{ 1074511473, 415881715, -1042246412, 1726958389, -766953297, 252101555, 587590174 };
                for (int ax$5 = -386; ax$5 < (-386 + 18137); ax$5 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        if (i29 == 10) {
                            lMeth_check_sum++;
                    ...
                    Test.AxOutputRedirectionHelper.recover();
                    Test.ax$0 = true;
                    iMeth(204050466, 0.7134169441109006, -5466620504405747193L);
                    Test.ax$0 = false;
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        ax$12[i24] = ((int) (ax$9[i24] / (-i)));
