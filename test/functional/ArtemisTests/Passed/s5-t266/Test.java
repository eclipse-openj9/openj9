                                ...
                                case 72 :
                                    {
                                        ...
                                        try {
                                            String ax$2 = "s";
                                            long[] ax$5 = new long[]{ -1845923245644145034L, 2894061136719084056L };
                                            long[] ax$6 = new long[60];
                                            long[] ax$8 = new long[]{ 7L, 7L, 5L, 5L, 7L, 7L, 7L, 5L, 5L };
                                            boolean ax$1 = false;
                                            for (int ax$0 = -578; ax$0 < (-578 + 2846); ax$0 += 1) {
                                                Test.AxOutputRedirectionHelper.redirect();
                                                try {
                                                    try {
                                                        ax$2.charAt(500);
                                                    } catch (StringIndexOutOfBoundsException ax$3) {
                                                    }
                                                ...
                                                Test.AxOutputRedirectionHelper.redirect();
                                                try {
                                                    ax$8[i29] = ((long) (ax$5[i29] & ax$6[i29]));
