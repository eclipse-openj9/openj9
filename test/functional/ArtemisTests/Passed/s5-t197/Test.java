...
public class Test {
    ...
    public static int iMeth1(int i11) {
        ...
        {
            final int ax$8 = Test.iFld1;
            try {
                StampedLock ax$1 = new StampedLock();
                CyclicBarrier ax$3 = null;
                CyclicBarrier ax$4 = new CyclicBarrier(3);
                for (int ax$0 = -962; ax$0 < (-962 + 9362); ax$0 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        for (iFld1 = 0; iFld1 < 1024; ++iFld1) {
                            try {
                                ax$3.await();
                                long ax$5 = ax$1.writeLock();
                                ax$4.await();
                                Thread.sleep(10);
                                ax$1.unlockWrite(ax$5);
                            } catch (Exception ax$6) {
                            }
                        }
    ...
    public long lMeth(float f, boolean b) {
        ...
        for (i21 = 150; i21 > 2; i21--) {
            ...
            }
            {
                final int ax$13 = i26;
                try {
                    Thread ax$11 = new Thread();
                    for (int ax$9 = -430; ax$9 < (-430 + 16843); ax$9 += 1) {
                        Test.AxOutputRedirectionHelper.redirect();
                        try {
                            ax$11.interrupt();
                            if (ax$11.isInterrupted()) {
                            }
                            i26++;
                            ax$11.join(1000);
