...
public class Test {
                                ...
                                case 119 :
                                    ...
                                    try {
                                        i11 = (-117) % i13;
                                        {
                                            ...
                                            final int ax$8 = i15;
                                            try {
                                                int[] ax$3 = new int[]{ -481239351, 1558233811, -604042309 };
                                                boolean ax$1 = false;
                                                for (int ax$0 = -45; ax$0 < (-45 + 11202); ax$0 += 1) {
    ...
    public static void main(String[] strArr) {
        {
            try {
                short[] ax$10 = new short[]{ ((short) (18737)), ((short) (-16804)), ((short) (15714)), ((short) (26417)), ((short) (-30509)), ((short) (14738)) };
                for (int ax$9 = -579; ax$9 < (-579 + 12974); ax$9 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
