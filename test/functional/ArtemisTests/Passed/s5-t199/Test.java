                            ...
                            for (i9 = 1; 2 > i9; i9++) {
                                ...
                                switch (((i3 >>> 1) % 3) + 22) {
                                    ...
                                    case 23 :
                                        ...
                                        {
                                            final boolean ax$9 = this.bFld;
                                            final int ax$10 = i3;
                                            try {
                                                String[][] ax$2 = new String[][]{ new String[]{ "s", "s", "s", "s" }, new String[]{ "s", "s", "s" } };
                                                for (int ax$0 = -532; ax$0 < (-532 + 2033); ax$0 += 1) {
                                                    Test.AxOutputRedirectionHelper.redirect();
                                                    try {
                                                        List<LanguageRange> ax$4 = LanguageRange.parse(ax$2[i3][0]);
                                                        ArrayList<LanguageRange> ax$5 = new ArrayList<>();
                                                        ax$5.add(new LanguageRange(ax$2[i3][0], 1.0));
                                                        ax$5.add(new LanguageRange(ax$2[i3][1], 1.0));
                                                        if (!ax$5.equals(ax$4)) {
                                                            bFld = true;
                                                            for (LanguageRange ax$6 : ax$5) {
                                                            }
                                                            for (LanguageRange ax$7 : ax$4) {
                                                            }
                                                        }
                ...
                do {
                    ...
                    switch (((i21 % 6) * 5) + 83) {
                        ...
                        case 92 :
                            i23 += i26;
                            {
                                final long ax$15 = Test.lMeth_check_sum;
                                try {
                                    for (int ax$11 = -963; ax$11 < (-963 + 1204); ax$11 += 1) {
                                        Test.AxOutputRedirectionHelper.redirect();
                                        try {
                                            try {
                                                lMeth_check_sum = Long.decode(System.getProperty("divisor"));
