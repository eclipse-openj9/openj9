...
public class Test {
                ...
                case 19 :
                    ...
                    do {
                        ...
                        while ((i23 += 3) < 1) {
                            ...
                            {
                                final long ax$22 = Test.vMeth_check_sum;
                                final long ax$23 = Test.iMeth_check_sum;
                                try {
                                    for (int ax$18 = -894; ax$18 < (-894 + 9096); ax$18 += 1) {
                                    ...
                                    Test.vMeth_check_sum = ax$22;
                                    Test.iMeth_check_sum = ax$23;
                                }
                            }
                            Test.fFld = i;
                            iArr2[i1 + 1] += 45;
    ...
    public void mainTest(String[] strArr1) {
        if (Test.ax$0) {
            ...
            int[] ax$1 = new int[]{ -1077893380, 888652414, -2021112962, -234564838, 1332639779, 1780606088, 1882122518, -1234361963, 900258790 };
            Test.AxOutputRedirectionHelper.redirect();
            try {
                iFld += ax$1[iFld];
            ...
            for (int i = 0; i < 10; i++) {
                {
                    ...
                    final int ax$17 = i;
                    try {
                        byte[] ax$7 = new byte[]{ ((byte) (-92)), ((byte) (-112)), ((byte) (12)), ((byte) (-38)) };
                        byte[] ax$10 = new byte[0];
                        Double ax$12 = new Double(8.5F);
                        Double[] ax$13 = new Double[]{ 0.570965441776567 };
                        for (int ax$6 = -3; ax$6 < (-3 + 8835); ax$6 += 1) {
                            Test.AxOutputRedirectionHelper.redirect();
                            try {
                                ax$10[iFld] = ((byte) (ax$7[iFld] >> (-i)));
