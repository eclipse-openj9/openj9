...
public class Test {
    ...
    public static void vMeth2(float f) {
        ...
        int i9 = 6;
        {
            try {
                int[] ax$10 = new int[8];
                for (int ax$9 = -882; ax$9 < (-882 + 15905); ax$9 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        for (int ax$11 = 1; ax$11 < (256 * 256); ax$11++) {
                            ax$10[ax$11] = 1;
                        }
    ...
    public static void vMeth1(double d, double d1, int i3) {
        ...
        for (i15 = 6; i15 < 158; ++i15) {
            ...
            {
                try {
                    for (int ax$0 = -252; ax$0 < (-252 + 4593); ax$0 += 1) {
                        Test.AxOutputRedirectionHelper.redirect();
                        try {
                            for (int ax$1 = 0; ax$1 < 4; ax$1++) {
                                for (int ax$2 = 0; ax$2 < 4; ax$2++) {
                                    for (int ax$3 = 0; ax$3 < 4; ax$3++) {
                                    }
                                    for (int ax$4 = 0; ax$4 < 4; ax$4++) {
                                    }
                                }
                                for (int ax$5 = 0; ax$5 < 4; ax$5++) {
                                    for (int ax$6 = 0; ax$6 < 4; ax$6++) {
                                    }
                                }
                            }
                            for (int ax$7 = 0; ax$7 < 4; ax$7++) {
                            }
