                    ...
                    case 52 :
                        for (i18 = 1; i18 < 1; i18++) {
                            ...
                            i17 -= ((int) (Test.instanceCount));
                            {
                                try {
                                    boolean ax$10 = false;
                                    for (int ax$9 = -14; ax$9 < (-14 + 15628); ax$9 += 1) {
                                        ...
                                        Test.AxOutputRedirectionHelper.redirect();
                                        try {
                                            BigInteger ax$12 = BigInteger.ONE.shiftLeft(2147483646);
                                            BigInteger ax$13 = BigInteger.ONE.shiftLeft(1568);
                                            BigInteger[] ax$14 = ax$12.divideAndRemainder(ax$13);
                                            BigInteger ax$15 = ax$14[0];
                                            BigInteger ax$16 = ax$14[1];
                                            if (!ax$16.equals(BigInteger.ZERO));
                                            if (ax$15.bitLength() != 2147482079);
                        ...
                        case 96 :
                            ...
                            for (i9 = 1; 2 > i9; i9++) {
                                ...
                                switch (((i3 >>> 1) % 3) + 22) {
                                    ...
                                    default :
                                        {
                                            final int ax$7 = this.iFld;
                                            final int ax$8 = i5;
                                            try {
                                                Object[] ax$2 = new Object[250];
                                                boolean ax$1 = false;
                                                for (int ax$0 = -12; ax$0 < (-12 + 19502); ax$0 += 1) {
                                                    Test.AxOutputRedirectionHelper.redirect();
                                                    try {
                                                        ax$2 = new Object[iFld];
