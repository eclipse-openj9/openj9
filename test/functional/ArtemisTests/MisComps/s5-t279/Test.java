...
public class Test {
    ...
    public static long lMeth() {
        if (Test.ax$0) {
            final int ax$4 = Test.iFld;
            String[] ax$1 = new String[]{ "s", "s", "s", "s", "s", "s", "s", "s" };
            Test.AxOutputRedirectionHelper.redirect();
            try {
                iFld = Integer.parseInt(ax$1[1]);
            } catch (Throwable ax$3) {
            } finally {
            }
            Test.AxOutputRedirectionHelper.recover();
            Test.iFld = ax$4;
            return 2918033221487489210L;
        }
        float f = 1.567F;
        float f1 = 0.75F;
        int i16 = 186;
    ...
    public void mainTest(String[] strArr1) {
        ...
        {
            final int ax$13 = i28;
            final int ax$14 = this.iFld2;
            final int ax$15 = i31;
            final int ax$16 = i36;
            try {
                List<Integer> ax$6 = null;
                for (int ax$5 = -697; ax$5 < (-697 + 8811); ax$5 += 1) {
                    Test.AxOutputRedirectionHelper.redirect();
                    try {
                        new CopyOnWriteArrayList<Integer>(ax$6);
