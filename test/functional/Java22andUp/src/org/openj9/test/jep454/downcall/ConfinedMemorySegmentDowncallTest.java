...
public class ConfinedMemorySegmentDowncallTest {
	...
	public void test_confinedSegmentWrongThreadAccess() throws Throwable {
		...
		MemorySegment functionSymbol = null;
		...
		structSegment = segmentRef.get();
		functionSymbol = nativeLibLookup.find("addIntAndIntsFromStructPointer").get();
		fd = FunctionDescriptor.of(JAVA_INT, JAVA_INT, ADDRESS);
