...
public class MXBeansGetterSanityTestRunner extends Runner {

	public MXBeansGetterSanityTestRunner(String className, String exeName, String bootClassPath, String userClassPath, String javaVersion) {
