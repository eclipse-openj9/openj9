...
/**
 *		Create a parent classloader and one child.  Ask the child to load a class and let the parent find
 *	it.  Retain only a reference to the child.  Nothing is unloaded.
 *
 */
public class LoadWithParentAndDiscardParentTest extends ClassUnloadingTestParent {
public static void main(String[] args) throws Exception {
	new LoadWithParentAndDiscardParentTest().runTest();
}
...
protected void createScenario() throws Exception {
	...
	child = new SelectiveJarClassLoader("child", jarFileName, parent, "j9vm.test.classunloading.classestoload.ClassToLoad1");
