...
set CLASSPATH=.
set CLASSPATH=%CLASSPATH%;C:\ive\lib\jclMax\classes.zip
set CLASSPATH=%CLASSPATH%;C:\ive\lib\jclMax\locale.zip
set CLASSPATH=%CLASSPATH%;C:\ive\lib\charconv.zip
set CLASSPATH="%CLASSPATH%"
set JRE_BIN=c:\ive\bin
set ZIP_FILE=ZipTester.jar

ZipTester2 %JRE_BIN% %CLASSPATH% %ZIP_FILE%
@echo on
