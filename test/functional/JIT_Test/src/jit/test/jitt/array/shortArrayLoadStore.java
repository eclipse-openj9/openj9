...
public class shortArrayLoadStore extends jit.test.jitt.Test {

	private static Logger logger = Logger.getLogger(shortArrayLoadStore.class);

	static short initArry[]= {0,1,-32768,32767};



	private boolean tstCheck(short arrayP[]){
	...
	private short[] tstFoo(short[] arrayP,int zero) {
	...
	@Test
	public void testshortArrayLoadStore() {

		int zero = 0;



		shortArrayLoadStore x = new shortArrayLoadStore();
