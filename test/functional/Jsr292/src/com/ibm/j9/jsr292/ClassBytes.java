...
public class ClassBytes {
	...
	public static byte[] classBytes_DifferentPackage() throws Exception {
		...
		MethodVisitor mv;
		cw.visit(V1_2, ACC_PUBLIC + ACC_SUPER, "com/ibm/j9/jsr292/api/SamePackageExample1", null, "java/lang/Object", null);
		...
		Label l1 = new Label();
		mv.visitLabel(l1);
		mv.visitLocalVariable("this", "Lcom/ibm/j9/jsr292/api/SamePackageExample1;", null, l0, l1, 0);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
		}
		cw.visitEnd();
	...
	public static byte[] invalidClassBytes_SamePackage() throws Exception {
		...
		cw.visit(V1_2, ACC_PUBLIC + ACC_SUPER, "com/ibm/j9/jsr292/SamePackageExample2", null, "java/lang/Object", null);
		...
		Label l1 = new Label();
		mv.visitLabel(l1);
		mv.visitLocalVariable("this", "Lcom/ibm/j9/jsr292/SamePackageExample2;", null, l0, l1, 0);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
		}
		cw.visitEnd();
	...
	public static byte[] validClassBytes_SamePackage() throws Exception {
		...
		cw.visit(V1_2, ACC_PUBLIC + ACC_SUPER, "com/ibm/j9/jsr292/SamePackageExample3", null, "java/lang/Object", null);
		...
		Label l1 = new Label();
		mv.visitLabel(l1);
		mv.visitLocalVariable("this", "Lcom/ibm/j9/jsr292/SamePackageExample3;", null, l0, l1, 0);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
		}
		{
		...
		mv.visitFieldInsn(GETSTATIC, "com/ibm/j9/jsr292/SamePackageExample3", "class$0", "Ljava/lang/Class;");
		mv.visitInsn(DUP);
		Label l4 = new Label();
		mv.visitJumpInsn(IFNONNULL, l4);
		mv.visitInsn(POP);
		mv.visitLabel(l0);
		mv.visitLdcInsn("com.ibm.j9.jsr292.SamePackageExample3");
		mv.visitMethodInsn(INVOKESTATIC, "java/lang/Class", "forName", "(Ljava/lang/String;)Ljava/lang/Class;");
		mv.visitLabel(l1);
		mv.visitInsn(DUP);
		mv.visitFieldInsn(PUTSTATIC, "com/ibm/j9/jsr292/SamePackageExample3", "class$0", "Ljava/lang/Class;");
		...
		Label l5 = new Label();
		mv.visitLabel(l5);
		mv.visitLocalVariable("this", "Lcom/ibm/j9/jsr292/SamePackageExample3;", null, l3, l5, 0);
		mv.visitMaxs(3, 1);
		mv.visitEnd();
		}
		cw.visitEnd();
