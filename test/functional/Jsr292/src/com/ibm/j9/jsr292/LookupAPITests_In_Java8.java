 ...
 */
public class LookupAPITests_In_Java8 {
	
	static final int NO_ACCESS = 0;
	static final int PUBLIC_PACKAGE_MODE =  Lookup.PUBLIC | Lookup.PACKAGE; // 9
	static final int PUBLIC_PACKAGE_PRIVATE_MODE = Lookup.PUBLIC | Lookup.PRIVATE | Lookup.PACKAGE; //11
	static final int PUBLIC_PACKAGE_PROTECTED_MODE =  Lookup.PUBLIC |  Lookup.PACKAGE | Lookup.PROTECTED; //13
	static final int FULL_ACCESS_MODE = Lookup.PUBLIC | Lookup.PRIVATE | Lookup.PROTECTED | Lookup.PACKAGE; //15
	...
	public void testPublicLookup() throws Throwable {
		assertClassAndMode(localPublicLookup, Object.class, Lookup.PUBLIC);
		Assert.assertEquals(localPublicLookup.lookupModes(), Lookup.PUBLIC);
	...
	public void testLookup_inObject_Self() throws Throwable {
		Lookup newLookup = localLookup.in(LookupAPITests_In_Java8.class);
		assertClassAndMode(newLookup, LookupAPITests_In_Java8.class, FULL_ACCESS_MODE);
	}
	...
	public void testLookup_inObject() throws Throwable {
		...
		assertClassAndMode(inObject, Object.class, Lookup.PUBLIC);
	}
	...
	public void testLookup_inObject_Using_publicLookup() throws Throwable {
		 ...
		 * */
		assertClassAndMode(inObject, int.class, Lookup.PUBLIC);
	}
	
	/**
	 * Validates access restrictions stored in a new Lookup object created from the Lookup object of this class (LookupAPITests_In_Java8) 
	...
	public void testLookup_in_Assert() throws Throwable {
		...
		assertClassAndMode(newLookup, Assert.class, Lookup.PUBLIC);
	}
	...
	public void testLookup_CrossPackageLookup_Subclass() throws Throwable {
		...
		assertClassAndMode(inObject, CrossPackageExampleSubclass.class, Lookup.PUBLIC);
	}
	...
	public void testLookup_PublicInnerClassLookup_CrossPackage() throws Throwable {
		...
		assertClassAndMode(inObj, SamePackageInnerClass.class, Lookup.PUBLIC);
	}
	...
	public void testLookup_ProtectedInnerClassLookup_CrossPackage() throws Throwable {
		...
		assertClassAndMode(inObj, SamePackageInnerClass_Protected.class, Lookup.PUBLIC);
	}
	...
	public void testLookup_UnrelatedClassLoaders() throws Throwable {
		...
		assertClassAndMode(inObject, customLoadedClass.getClass(), Lookup.PUBLIC);
	}
	...
	public void testLookup_RelatedClassLoaders_ChildLookupInParent() throws Throwable {
		ParentCustomClassLoader parentCustomCL = new ParentCustomClassLoader(LookupAPITests_In_Java8.class.getClassLoader());
	    ...
	    assertClassAndMode(inObject, customLoadedClass1.getClass(), Lookup.PUBLIC);
	}
	...
	public void testLookup_RelatedClassLoaders_ParentLookupInChild() throws Throwable {
	    ...
	    assertClassAndMode(inObject, customLoadedClass2.getClass(), Lookup.PUBLIC);
	}
	...
	public void test_Lookup_toString() {
		...
		Assert.assertEquals(inPrivateClass.toString(), "com.ibm.j9.jsr292.LookupAPITests_In_Java8$PackageClass/private");
		
		lookup = MethodHandles.publicLookup();
		Lookup inNoAccess = lookup.in(PackageClass.class);
		Assert.assertEquals(inNoAccess.toString(), "com.ibm.j9.jsr292.LookupAPITests_In_Java8$PackageClass/noaccess");
	}
