...
public class LookupAPITests_In {
	...
	static final int PUBLICLOOKUP_MODE =  Lookup.PUBLIC | Lookup.UNCONDITIONAL; // 33
	...
	public void testPublicLookup() throws Throwable {
		...
		assertClassAndMode(newLookup, int[].class, Lookup.PUBLIC);
	}
	...
	public void testLookup_inObject_Self() throws Throwable {
		...
		assertClassAndMode(newLookup, LookupAPITests_In.class, FULL_ACCESS_MODE);
	}
