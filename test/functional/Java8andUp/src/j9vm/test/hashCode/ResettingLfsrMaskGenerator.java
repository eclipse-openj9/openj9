...
public class ResettingLfsrMaskGenerator extends LfsrMaskGenerator {
	Lfsr gen;
	int previousHashCode = 0;
	boolean changedSeed;

	public ResettingLfsrMaskGenerator(int initialSeed) {
		super(initialSeed);
		gen = new Lfsr();
	}
	...
	public int processHashCode(int hashCode) {
		...
		return super.processHashCode(hashCode);
	}
