...
import org.openj9.test.java.lang.invoke.helpers.Helper_MethodHandleInfoOtherPackagePublic;

class Helper_MethodHandleInfoSubClass extends Helper_MethodHandleInfoOtherPackagePublic {
	public static MethodHandles.Lookup lookup() { return MethodHandles.lookup(); }

	public Helper_MethodHandleInfoSubClass() { }
	Helper_MethodHandleInfoSubClass(int i) { }
