...
public class ValueTypeTests {
	...
	static public void testInitialValueInNullRestrictedPointArray() throws Throwable {
		Object initialPoint = makePoint2D.invoke(0, 0);
		...
		for (int i = 0; i < genericArraySize; i++) {
			...
			assertEquals(getX.invoke(pointObject), 0);
			assertEquals(getY.invoke(pointObject), 0);
		}
	}
	...
	static public void testInitialValueInNullRestrictedLineArray() throws Throwable {
		...
		for (int i = 0; i < genericArraySize; i++) {
			...
			assertEquals(0, getX.invoke(st));
			assertEquals(0, getY.invoke(st));
			assertEquals(0, getX.invoke(en));
			assertEquals(0, getY.invoke(en));
		}
	...
	static public void testInitialValueInNullRestrictedTriangleArray() throws Throwable {
		...
		Object initialLine2 = makeFlattenedLine2D.invoke(initialV1, initialV2);
		Object initialLine3 = makeFlattenedLine2D.invoke(initialV1, initialV2);
