...
public class TestThreadInfo {
	...
	private static final boolean GOOD_DAEMON = false;

	private static final int GOOD_PRIORITY = Thread.NORM_PRIORITY;
	...
	protected static void initGlobalDataStructures() {
		...
		String[] typeNamesGlobalTmp = { "threadId", "threadName",
				...
				"lockedMonitors", "lockedSynchronizers", "daemon", "priority" };
		...
		String[] typeDescsGlobalTmp = { "blah threadId", "blah threadName",
				"blah threadState", "blah suspended", "blah inNative",
				"blah blockedCount", "blah blockedTime", "blah waitedCount",
				"blah waitedTime", "blah lockInfo", "blah lockName",
				"blah lockOwnerId", "blah lockOwnerName", "blah stackTrace",
				"blah lockedMonitors", "blah lockedSynchronizers",
				"blah daemon", "blah priority" };
	...
	/*
	 * Test method for 'java.lang.management.ThreadInfo.getPriority()'
	 */
	@Test
	public final void testGetPriority() {
		AssertJUnit.assertEquals(GOOD_PRIORITY, goodThreadInfo.getPriority());
	}

	/*
	 * Test method for 'java.lang.management.ThreadInfo.isDaemon()'
	 */
	@Test
	public final void testIsDaemon() {
		AssertJUnit.assertEquals(GOOD_DAEMON, goodThreadInfo.isDaemon());
	}
	...
	protected static CompositeType createGoodStackTraceElementCompositeType() {
		CompositeType result = null;
		String[] typeNames = TestMisc.getJava9STEMethodNames();
		String[] typeDescs = TestMisc.getJava9STEMethodNames();
		OpenType[] typeTypes = {
				SimpleType.STRING,
				SimpleType.STRING,
				SimpleType.STRING,
