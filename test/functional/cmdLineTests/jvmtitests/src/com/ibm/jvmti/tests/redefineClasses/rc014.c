...
jint JNICALL
rc014(agentEnv * agent_env, char * args)
{
	jvmtiError err;
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc014_redefineClass(JNIEnv * jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc014_redefineClassExpectFailure(JNIEnv * jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
	JVMTI_ACCESS_FROM_AGENT(env);
	jbyte * class_bytes;
	char * classFileName = env->testArgs;
