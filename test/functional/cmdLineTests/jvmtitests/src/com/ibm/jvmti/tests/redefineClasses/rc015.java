...
public class rc015 {
	...
	public boolean testReflectMethodIDRedefine()	{
		Class noparams[] = {};
		try {
			...
			boolean redefined = Util.redefineClass(getClass(), rc015_testReflectMethodIDRedefine_Super_1.class, rc015_testReflectMethodIDRedefine_Super_1.class);
			...
			System.out.println("rc015 encountered unexpected exception "+ e.getMessage());
			return false;
		}
	}
