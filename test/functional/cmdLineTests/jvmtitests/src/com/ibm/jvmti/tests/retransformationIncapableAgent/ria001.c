            ...
            unsigned char** new_class_data)
{
	...
	if ((0 == strcmp(name, CLASS_PACKAGE "/" TEST_CLASS_NAME))
		...
		(*jni_env)->SetStaticBooleanField(jni_env, agentJavaClass, riHookCalledFieldId, JNI_TRUE);
 ...
 *
 * It is a re-transformation incapable agent.
 ...
 */
jint JNICALL
ria001(agentEnv * agent_env, char * args)
{
	jvmtiError err;
