...
public class IllegalAccessErrorTest {
	...
	public static void main(String[] args) throws Exception {
		...
		try (InputStream in = ucl.getResourceAsStream("org/openj9/test/illegalAccessError/ExtendsDefaultVisibility.class")) {
			...
			if (((VersionCheck.major() == 8) && e.getCause().toString().contains(
					"java.lang.IllegalAccessError: class org/openj9/test/illegalAccessError/ExtendsDefaultVisibility (from loader java/net/URLClassLoader) cannot access its superclass org/openj9/test/illegalAccessError/DefaultVisibility (from loader sun/misc/Launcher$AppClassLoader)"))
					|| ((VersionCheck.major() >= 11) && e.getCause().toString().contains(
		...
		try (InputStream in = ucl.getResourceAsStream("org/openj9/test/illegalAccessError/ImplementDefaultVisibilityInterface.class")) {
			...
			if (((VersionCheck.major() == 8) && e.getCause().toString().contains(
					"java.lang.IllegalAccessError: class org/openj9/test/illegalAccessError/ImplementDefaultVisibilityInterface (from loader java/net/URLClassLoader) cannot access its superinterface org/openj9/test/illegalAccessError/DefaultVisibilityInterface (from loader sun/misc/Launcher$AppClassLoader)"))
					|| ((VersionCheck.major() >= 11) && e.getCause().toString().contains(
							"java.lang.IllegalAccessError: class org/openj9/test/illegalAccessError/ImplementDefaultVisibilityInterface (in unnamed module 0x0000000000000000 from loader java/net/URLClassLoader) cannot access its superinterface org/openj9/test/illegalAccessError/DefaultVisibilityInterface (in unnamed module 0x0000000000000000 from loader jdk/internal/loader/ClassLoaders$AppClassLoader)"))) {
				result = true;
		...
		try (InputStream in = ucl.getResourceAsStream("org/openj9/test/illegalAccessError/ExtendsDefaultVisibilityInterface.class")) {
			...
			if (((VersionCheck.major() == 8) && e.getCause().toString().contains(
					"java.lang.IllegalAccessError: interface org/openj9/test/illegalAccessError/ExtendsDefaultVisibilityInterface (from loader java/net/URLClassLoader) cannot access its superinterface org/openj9/test/illegalAccessError/DefaultVisibilityInterface (from loader sun/misc/Launcher$AppClassLoader)"))
					|| ((VersionCheck.major() >= 11) && e.getCause().toString().contains(
							"java.lang.IllegalAccessError: interface org/openj9/test/illegalAccessError/ExtendsDefaultVisibilityInterface (in unnamed module 0x0000000000000000 from loader java/net/URLClassLoader) cannot access its superinterface org/openj9/test/illegalAccessError/DefaultVisibilityInterface (in unnamed module 0x0000000000000000 from loader jdk/internal/loader/ClassLoaders$AppClassLoader)"))) {
				result = true;
