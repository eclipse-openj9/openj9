...
/**
 * Stale marking - load a resource and check its cached. Then store null against the same key which will mark it stale
 * then finally take another look in the cache for it - shouldn't be found.
 */
public class DataCachingTest04 extends DataCachingTestbase {

	public static void main(String[] args) {
		new DataCachingTest04().run();
	}
