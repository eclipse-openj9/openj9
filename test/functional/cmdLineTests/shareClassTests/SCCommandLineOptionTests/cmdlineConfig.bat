...
rem
rem Copyright (c) 2009, 2018 IBM Corp. and others
rem
...
rem @summary exports user names to the batch file

rem use the environment variable USERNAME to get the username 
IF DEFINED USERNAME (set TESTUSER=%USERNAME%) ELSE (set TESTUSER=%USER%)
set CFGUSER=%%utest
set CFGFULLUSER=%TESTUSER%test
