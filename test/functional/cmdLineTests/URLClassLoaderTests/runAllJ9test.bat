...
set BASEDIR="C:\j9test\testsuite60\SharedClasses\URLClassLoaderTests"

set NETUSEDIR=\\nescafe.hursley.ibm.com\testsuite\sharedClassesResults

set TESTJREBASE=C:\j9test\testjdk\jvmwa6460\sdk
set REFJREBASE=C:\j9test\refjdk\sdk
