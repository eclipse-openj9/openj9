...
%1\jar -cvfm AB.jar Manifests\AB\manifest.mf jnurlcldr\shared\signedsealed\*.class jnurlcldr\shared\notsealed\*.class
%1\jar -cvf B1.jar jnurlcldr\shared\signedsealed\B*.class jnurlcldr\shared\notsealed\*.class
