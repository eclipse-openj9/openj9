 ...
 */
public class ChildCustomClassLoader extends ParentCustomClassLoader {

	public ChildCustomClassLoader( ClassLoader parent ) {
		super( parent );
	}
	
	@Override
	public Class<?> loadClass( String className ) throws ClassNotFoundException {
		if ( className.equals( "com.ibm.j9.jsr292.CustomLoadedClass2" ) ) {
