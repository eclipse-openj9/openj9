...
jint JNICALL
rc008(agentEnv * agent_env, char * args)
{
	jvmtiError err;
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc008_redefineClass(JNIEnv * jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
