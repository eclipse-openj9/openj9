...
jint JNICALL
rc013(agentEnv * agent_env, char * args)
{
	jvmtiError err;
	...
	capabilities.can_generate_breakpoint_events = 1; /* to enable J9 extensions */
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc013_redefineClass(JNIEnv * jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
