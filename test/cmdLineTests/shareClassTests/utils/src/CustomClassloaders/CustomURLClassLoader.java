 ...
 */
public class CustomURLClassLoader extends SecureClassLoader {
	...
	public CustomURLClassLoader(URL[] passedUrls, ClassLoader parent){
		super(parent);
	...
	public CustomURLClassLoader(URL[] passedUrls){
		super();
		loaderType = ClassLoaderType.CACHEDURL.ord;
		int urlLength = passedUrls.length;
		urls = new URL[urlLength];
