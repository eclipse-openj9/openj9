...
set TESTJREBASE=C:\ben\j9vmwi3224\sdk
...
set EXCLUDEFILE=excludeJava6.xml
...
call runTest.bat %REFJREBIN% %REFBIN% %BASEDIR% %TESTEXE% %TESTEXTDIR% %NETUSEDIR% %EXCLUDEFILE% JVMTI %1
