...
%1\java -DTESTBASE=%3 -DTESTSUITE=%8 -DTOOLSDIR=%2 -DEXTDIR=%5 -DNETDIR=%6 -DEXE=%4 -DVMOPTIONS=%9 -jar C:\j9test\cmdlinetester\cmdlinetester.jar -config %3\%8\%8_win.xml -xids all -xlist %3\%7
