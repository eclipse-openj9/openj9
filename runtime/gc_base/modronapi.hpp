...
UDATA j9gc_get_max_tenuring_threshold(J9JavaVM *javaVM);
UDATA j9gc_get_initial_tenuring_threshold(J9JavaVM *javaVM);
...
UDATA j9gc_get_gc_collector_type(J9VMThread *vmThread);
UDATA j9gc_get_gc_cause_type(J9VMThread *vmThread);
U_64 j9gc_get_longest_pause(J9VMThread *vmThread);
U_64 j9gc_get_sum_of_pauses(J9VMThread *vmThread);
