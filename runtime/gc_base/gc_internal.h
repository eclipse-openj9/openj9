...
extern J9_CFUNC UDATA j9gc_hot_reference_field_required(J9JavaVM *javaVM);
...
extern J9_CFUNC void j9gc_report_j9_hot_field_info(int32_t reducedCpuUtil, J9Class* clazz, U_8 fieldOffset,  U_32 reducedFrequency);
