...
R2       EQU      2 * input: address of the last byte for protection
R3       EQU      3 * output: the return code
R15      EQU     15

         AIF ('&SYSPARM' EQ 'BIT64').JMP1
_MPROT   EDCXPRLG BASEREG=8
         PGSER R,PROTECT,A=(R1),EA=(R2)
         LR R3,R15
         EDCXEPLG
         AGO .JMP2
