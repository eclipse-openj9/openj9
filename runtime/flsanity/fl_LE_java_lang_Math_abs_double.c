...
#include "floatsanityg.h"
   ...
   void group_java_lang_Math_abs_double() {
      int i=0, groupNum=27,numTests=33;
      ...
      unsigned int op_0 [] = {
         ...
         0xeb1c432d,0x3f2a36e2, 
         0xeb1c432d,0xbf2a36e2, 
         0x00000000,0x40000, 
      ...
      for (i=0; i<numTests; i++) {
         r = java_lang_Math_abs_double(*(p0));
         if ( IS_DNAN(erp) ){
            if ( !(IS_DNAN(&r)) ){
      ...
      printf("[%d] %s Passed %d Failed %d Total %d \n", groupNum,"java_lang_Math_abs_double", testsPassed, testsFailed, numTests);
