...
double java_lang_StrictMath_cos ( double op_0 ) { 
	return Java_java_lang_StrictMath_cos(NULL, NULL, op_0);
}

double java_lang_StrictMath_acos ( double op_0 ) { 
	return Java_java_lang_StrictMath_acos(NULL, NULL, op_0);
}

double java_lang_StrictMath_log ( double op_0 ) { 
	return Java_java_lang_StrictMath_log(NULL, NULL, op_0);
}

double java_lang_StrictMath_sin ( double op_0 ) { 
	return Java_java_lang_StrictMath_sin(NULL, NULL, op_0);
}

double java_lang_StrictMath_asin ( double op_0 ) { 
	return Java_java_lang_StrictMath_asin(NULL, NULL, op_0);
}

double java_lang_StrictMath_pow ( double op_0, double op_1 ) { 
	return Java_java_lang_StrictMath_pow(NULL, NULL, op_0, op_1);
}

double java_lang_StrictMath_tan ( double op_0 ) { 
	return Java_java_lang_StrictMath_tan(NULL, NULL, op_0);
}

double java_lang_StrictMath_atan ( double op_0 ) { 
	return Java_java_lang_StrictMath_atan(NULL, NULL, op_0);
}

double java_lang_StrictMath_atan2 ( double op_0, double op_1 ) { 
	return Java_java_lang_StrictMath_atan2(NULL, NULL, op_0, op_1);
}

double java_lang_StrictMath_exp ( double op_0 ) { 
	return Java_java_lang_StrictMath_exp(NULL, NULL, op_0);
}
