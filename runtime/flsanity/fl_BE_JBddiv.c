...
#include "floatsanityg.h"
   ...
   void group_JBddiv() {
      ...
      unsigned int result [] = {
         ...
         0x00100000, 0x00000000,
         0x7ff80000, 0x00000000,
         0x802fffff, 0xffffffff,
         0x000fffff, 0xffffffff,
         0x000fffff, 0xffffffff,
         0x000fffff, 0xffffffff,
         0x000a83be, 0xd5f1643f,
         0x0, 0x0};
