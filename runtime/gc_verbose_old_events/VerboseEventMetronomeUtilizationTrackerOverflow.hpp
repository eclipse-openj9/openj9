...
#if !defined(EVENT_METRONOME_UTILIZATION_TRACKER_OVERFLOW_HPP_)
#define EVENT_METRONOME_UTILIZATION_TRACKER_OVERFLOW_HPP_
...
#endif /* EVENT_METRONOME_UTILIZATION_TRACKER_OVERFLOW_HPP_ */
