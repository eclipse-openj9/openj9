...
#if defined(LINUX) && (defined(J9VM_ARCH_X86) || defined(J9VM_ARCH_POWER) || defined(J9VM_ARCH_S390) || defined(J9VM_ARCH_AARCH64)) && defined(J9VM_ENV_DATA64)
#include <ucontext.h>
...
#define J9VM_GET_PC(ucontext) ((ucontext_t*)(ucontext))->uc_mcontext.pc
