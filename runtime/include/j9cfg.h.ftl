...
/* Ensure J9VM_JAVA9_BUILD is not defined elsewhere. */
#ifdef J9VM_JAVA9_BUILD
#error J9VM_JAVA9_BUILD already defined
#endif /* J9VM_JAVA9_BUILD */

#if JAVA_SPEC_VERSION >= 10
#  define J9VM_JAVA9_BUILD 999
#elif (JAVA_SPEC_VERSION == 9) && defined(OPENJ9_BUILD)
