...
ifelse(eval(JAVA_SPEC_VERSION >= 28), 1, `	jboolean (JNICALL *HasIdentity)(JNIEnv *env, jobject obj);', `dnl')
};
...
ifelse(eval(JAVA_SPEC_VERSION >= 28), 1, `	jboolean HasIdentity(jobject obj) { return functions->HasIdentity(this, obj); }', `dnl')
#endif
};
