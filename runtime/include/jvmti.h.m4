...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	unsigned int can_generate_early_vmstart : 1;'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	unsigned int can_generate_early_class_hook_events : 1;'', `dnl')
	unsigned int : 5;
	unsigned int : 16;
	unsigned int : 16;
	unsigned int : 16;
...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * GetAllModules)(jvmtiEnv* env, jint* module_count_ptr, jobject** modules_ptr);'', `dnl')
...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * GetNamedModule)(jvmtiEnv* env, jobject class_loader, const char* package_name, jobject* module_ptr);'', `dnl')
...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * AddModuleReads)(jvmtiEnv* env, jobject module, jobject to_module);'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * AddModuleExports)(jvmtiEnv* env, jobject module, const char* pkg_name, jobject to_module);'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * AddModuleOpens)(jvmtiEnv* env, jobject module, const char* pkg_name, jobject to_module);'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * AddModuleUses)(jvmtiEnv* env, jobject module, jclass service);'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * AddModuleProvides)(jvmtiEnv* env, jobject module, jclass service, jclass impl_class);'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError (JNICALL * IsModifiableModule)(jvmtiEnv* env, jobject module, jboolean* is_modifiable_module_ptr);'', `dnl')
...
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError AddModuleReads(jvmtiEnv* env, jobject module, jobject to_module) { return functions->AddModuleReads(this, module, to_module); }'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError AddModuleExports(jvmtiEnv* env, jobject module, const char* pkg_name, jobject to_module) { return functions->AddModuleExports(this, module, pkg_name, to_module); }'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError AddModuleOpens(jvmtiEnv* env, jobject module, const char* pkg_name, jobject to_module) { return functions->AddModuleOpens(this, module, pkg_name, to_module); }'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError AddModuleUses(jvmtiEnv* env, jobject module, jclass service) { return functions->AddModuleUses(this, module, service); }'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError AddModuleProvides(jvmtiEnv* env, jobject module, jclass service, jclass impl_class) { return functions->AddModuleProvides(this, module, service, impl_class); }'', `dnl')
ifelse(eval(JAVA_SPEC_VERSION >= 9), 1, ``	jvmtiError IsModifiableModule(jvmtiEnv* env, jobject module, jboolean* is_modifiable_module_ptr) { return functions->IsModifiableModule(this, module, is_modifiable_module_ptr); }'', `dnl')
