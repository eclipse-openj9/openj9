...
void
TR::S390J9CallSnippet::print(TR::Logger *log, TR_Debug *debug)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::S390UnresolvedCallSnippet * snippet)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::S390VirtualSnippet * snippet)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::S390VirtualUnresolvedSnippet * snippet)
   {
   uint8_t * bufferPos = snippet->getSnippetLabel()->getCodeLocation();
   TR::SymbolReference * methodSymRef = snippet->getNode()->getSymbolReference();
...
void
TR_Debug::print(TR::Logger *log, TR::S390InterfaceCallSnippet * snippet)
   {
   uint8_t * bufferPos = snippet->getSnippetLabel()->getCodeLocation();
   TR::SymbolReference * methodSymRef = snippet->getNode()->getSymbolReference();
...
void
TR_Debug::print(TR::Logger *log, TR::J9S390InterfaceCallDataSnippet * snippet)
   {
   uint8_t * bufferPos = snippet->getSnippetLabel()->getCodeLocation();
...
void
TR::S390JNICallDataSnippet::print(TR::Logger *log, TR_Debug *debug)
   {
/*
       ramMethod
       JNICallOutFrameFlags
