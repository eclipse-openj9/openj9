...
bool J9::CFGSimplifier::simplifyUnresolvedRequireNonNull(bool needToDuplicateTree)
   ...
   trprints(trace(), log, "Start simplifyUnresolvedRequireNonNull\n");
   ...
   trprints(trace(), log, "   Match ResolveCHK of loadaddr\n");
   ...
   trprints(trace(), log, "   Matched new of loadaddr\n");
   ...
   trprints(trace(), log, "   Matched NPE init\n");
   ...
   trprints(trace(), log, "   Matched throw\n");
   ...
   trprintf(trace(), log, "End simplifyUnresolvedRequireNonNull. Generated NULLCHK node n%dn\n", nullchkNode->getGlobalIndex());
...
bool J9::CFGSimplifier::simplifyResolvedRequireNonNull(bool needToDuplicateTree)
   ...
   trprints(trace(), log, "Start simplifyResolvedRequireNonNull\n");
   ...
   trprintf(trace(), log, "   Found nullBlock %d\n", nullBlock->getNumber());
   ...
   trprints(trace(), log, "   Matched new tree\n");
   ...
   trprints(trace(), log, "   Matched new tree class\n");
   ...
   trprints(trace(), log, "   Matched exceptionNode\n");
   ...
   trprints(trace(), log, "   Matched exceptionNode call\n");
   ...
   trprints(trace(), log, "   Matched exception throw\n");
   ...
   TR::SymbolReference *symRef = comp()->getSymRefTab()->findOrCreateNullCheckSymbolRef(comp()->getMethodSymbol());
   TR::Node *nullchkNode = TR::Node::createWithSymRef(TR::NULLCHK, 1, 1, passthroughNode, symRef);
   trprintf(trace(), log, "End simplifyResolvedRequireNonNull. Generated NULLCHK node n%dn\n", nullchkNode->getGlobalIndex());
   TR::TreeTop *nullchkTree = TR::TreeTop::create(comp(), nullchkNode);
   checkBlock->getEntry()->insertAfter(nullchkTree);
