...
PassThrough node holding the load of the MethodHandle object that would have been returned by Invokers.checkVarHandleGenericType.
...
Blocks after transformation (JAVA_SPEC_VERSION <= 17) ==>
start Block_A
...
compressedRefs
   ...
   if (knot
      ...
      if (mhIndex != TR::KnownObjectTable::UNKNOWN)
         ...
         if (TR::Compiler->om.canGenerateArraylets())
            ...
            spineCHKNode->setAndIncChild(0, mhNode);
