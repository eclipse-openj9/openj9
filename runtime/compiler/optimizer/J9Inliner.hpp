...
class TR_J9InlinerPolicy : public OMR_InlinerPolicy
   ...
   protected:
      ...
      bool createUnsafePutWithOffset(TR::ResolvedMethodSymbol *, TR::ResolvedMethodSymbol *, TR::TreeTop *, TR::Node *, TR::DataType, TR::Symbol::MemoryOrdering ordering = TR::Symbol::TransparentSemantics, bool needNullCheck = false, bool isUnaligned = false);
      ...
      bool         createUnsafeGetWithOffset(TR::ResolvedMethodSymbol *, TR::ResolvedMethodSymbol *, TR::TreeTop *, TR::Node *, TR::DataType, TR::Symbol::MemoryOrdering ordering = TR::Symbol::TransparentSemantics, bool needNullCheck = false, bool isUnaligned = false);
