...
private:
    ...
    void getFrequencyThresholds(TR_ResolvedMethod *calleeMethod, int32_t &borderFrequency, int32_t &coldBorderFrequency,
        int32_t &veryColdBorderFrequency);
    int32_t scaleBasedOnFrequency(TR_ResolvedMethod *calleeMethod, TR::Node *callNode, TR_EstimateCodeSize *ecs,
