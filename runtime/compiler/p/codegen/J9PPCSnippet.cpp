...
void
TR::PPCReadMonitorSnippet::print(TR::Logger *log, TR_Debug *debug)
   {
   TR::Compilation *comp = cg()->comp();
   TR_J9VMBase *fej9 = (TR_J9VMBase *)(cg()->fe());
...
void
TR::PPCAllocPrefetchSnippet::print(TR::Logger *log, TR_Debug * debug)
   {
   TR_J9VMBase *fej9 = (TR_J9VMBase *)(cg()->fe());
...
void
TR::PPCNonZeroAllocPrefetchSnippet::print(TR::Logger *log, TR_Debug * debug)
   {
   TR_J9VMBase *fej9 = (TR_J9VMBase *)(cg()->fe());
   uint8_t *cursor = getSnippetLabel()->getCodeLocation();
