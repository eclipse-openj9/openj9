...
uint8_t *
TR_Debug::printPPCArgumentsFlush(TR::Logger *log, TR::Node *node, uint8_t *cursor, int32_t argSize)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::PPCCallSnippet * snippet)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::PPCUnresolvedCallSnippet * snippet)
   {
...
void
TR_Debug::print(TR::Logger *log, TR::PPCVirtualSnippet * snippet)
   {
   }

void
TR_Debug::print(TR::Logger *log, TR::PPCVirtualUnresolvedSnippet * snippet)
   {
   uint8_t            *cursor   = snippet->getSnippetLabel()->getCodeLocation();
   TR::Node            *callNode = snippet->getNode();
...
void
TR_Debug::print(TR::Logger *log, TR::PPCInterfaceCallSnippet * snippet)
   {
   uint8_t            *cursor   = snippet->getSnippetLabel()->getCodeLocation();
   TR::Node            *callNode = snippet->getNode();
