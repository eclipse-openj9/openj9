...
J9::RV::AheadOfTimeCompile::AheadOfTimeCompile(TR::CodeGenerator *cg) :
      J9::AheadOfTimeCompile(NULL, cg->comp()),
      _cg(cg)
   {
   }

void J9::RV::AheadOfTimeCompile::processRelocations()
   {
   J9::AheadOfTimeCompile::processRelocations();
   }

bool
J9::RV::AheadOfTimeCompile::initializePlatformSpecificAOTRelocationHeader(TR::IteratedExternalRelocation *relocation,
