...
#ifndef J9_RV_CODEGENERATOR_INCL
#define J9_RV_CODEGENERATOR_INCL
...
namespace J9 { namespace RV { class CodeGenerator; } }
namespace J9 { typedef J9::RV::CodeGenerator CodeGeneratorConnector; }
#else
#error J9::RV::CodeGenerator expected to be a primary connector, but a J9 connector is already defined
#endif
