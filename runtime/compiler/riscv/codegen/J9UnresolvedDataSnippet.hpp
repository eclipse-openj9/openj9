...
#ifndef J9_RV_UNRESOLVEDDATASNIPPET_INCL
#define J9_RV_UNRESOLVEDDATASNIPPET_INCL
...
namespace J9 { namespace RV { class UnresolvedDataSnippet; } }
namespace J9 { typedef J9::RV::UnresolvedDataSnippet UnresolvedDataSnippetConnector; }
#else
#error J9::RV::UnresolvedDataSnippet expected to be a primary connector, but a J9 connector is already defined
#endif
