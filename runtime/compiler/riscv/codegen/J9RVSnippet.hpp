...
#ifndef J9RVSNIPPET_INCL
#define J9RVSNIPPET_INCL
...
class RVMonitorEnterSnippet : public TR::RVHelperCallSnippet
   {
    ...
    * @brief Constructor
    */
   RVMonitorEnterSnippet(TR::CodeGenerator *codeGen,
                            TR::Node *monitorNode,
                            int32_t lwOffset,
...
class RVMonitorExitSnippet : public TR::RVHelperCallSnippet
   {
    ...
    * @brief Constructor
    */
   RVMonitorExitSnippet(TR::CodeGenerator *codeGen,
                           TR::Node *monitorNode,
                           int32_t lwOffset,
