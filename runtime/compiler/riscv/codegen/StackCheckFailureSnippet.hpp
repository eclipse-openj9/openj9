...
#ifndef RVSTACKCHECKFAILURESNIPPET_INCL
#define RVSTACKCHECKFAILURESNIPPET_INCL
...
class RVStackCheckFailureSnippet : public TR::Snippet
   {
   TR::LabelSymbol *reStartLabel;

   public:

   RVStackCheckFailureSnippet(TR::CodeGenerator *cg,
                                 TR::Node *node,
