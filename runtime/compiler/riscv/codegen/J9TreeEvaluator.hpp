...
#ifndef J9_RV_TREE_EVALUATOR_INCL
#define J9_RV_TREE_EVALUATOR_INCL
...
namespace J9 { namespace RV { class TreeEvaluator; } }
namespace J9 { typedef J9::RV::TreeEvaluator TreeEvaluatorConnector; }
#else
#error J9::RV::TreeEvaluator expected to be a primary connector, but a J9 connector is already defined
#endif
