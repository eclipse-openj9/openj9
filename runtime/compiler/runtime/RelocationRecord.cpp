...
TR_RelocationRecordValidateDynamicMethodFromCallsiteIndex::applyRelocation(TR_RelocationRuntime *reloRuntime, TR_RelocationTarget *reloTarget, uint8_t *reloLocation)
   ...
   uint16_t methodID = this->methodID(reloTarget);
   uint16_t calleeID = this->calleeID(reloTarget);
...
void
TR_RelocationRecordValidateDynamicMethodFromCallsiteIndex::setCalleeID(TR_RelocationTarget *reloTarget, uint16_t calleeID)
   {
   reloTarget->storeUnsigned16b(calleeID, (uint8_t *) &((TR_RelocationRecordValidateDynamicMethodFromCallsiteIndexBinaryTemplate *)_record)->_calleeID);
   }

uint16_t
TR_RelocationRecordValidateDynamicMethodFromCallsiteIndex::calleeID(TR_RelocationTarget *reloTarget)
   {
   return reloTarget->loadUnsigned16b((uint8_t *) &((TR_RelocationRecordValidateDynamicMethodFromCallsiteIndexBinaryTemplate *)_record)->_calleeID);
   }
...
void
TR_RelocationRecordValidateHandleMethodFromCPIndex::setCalleeID(TR_RelocationTarget *reloTarget, uint16_t calleeID)
   {
   reloTarget->storeUnsigned16b(calleeID, (uint8_t *) &((TR_RelocationRecordValidateHandleMethodFromCPIndexBinaryTemplate *)_record)->_calleeID);
   }

uint16_t
TR_RelocationRecordValidateHandleMethodFromCPIndex::calleeID(TR_RelocationTarget *reloTarget)
   {
   return reloTarget->loadUnsigned16b((uint8_t *) &((TR_RelocationRecordValidateHandleMethodFromCPIndexBinaryTemplate *)_record)->_calleeID);
   }
