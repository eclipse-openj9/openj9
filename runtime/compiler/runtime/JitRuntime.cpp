...
void setDllSlip(const char *CodeStart, const char *CodeEnd, const char *dllName, TR::Compilation *comp)
{
   ...
   if (sliphandle != 0)
      ...
      {
      trprints(trace, log, "Cannot load slip/trap DLL\n");
      }
#endif
   return;
