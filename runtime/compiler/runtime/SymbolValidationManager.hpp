...
public:
   ...
   bool addMethodFromSingleAbstractImplementerRecord(TR_OpaqueMethodBlock *method,
                                          ...
                                          int32_t vftSlot,
                                          TR_OpaqueMethodBlock *callerMethod);
   bool addDynamicMethodFromCallsiteIndex(TR_OpaqueMethodBlock *method, TR_OpaqueMethodBlock *calee, int32_t callsiteIndex, bool appendixObjectNull);
   bool addHandleMethodFromCPIndex(TR_OpaqueMethodBlock *method, TR_OpaqueMethodBlock *calee, int32_t cpIndex, bool appendixObjectNull);
