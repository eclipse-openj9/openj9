...
extern "C" void jitBytecodePrintFunction(void *userData, char *format, ...)
   ...
   TR::Logger *log = reinterpret_cast<TR::Logger *>(userData);
   log->prints(outputBuffer);
   }

void
TR_Debug::printByteCodeStack(TR::Logger *log, int32_t parentStackIndex, uint16_t byteCodeIndex, size_t *indentLen)
   {
