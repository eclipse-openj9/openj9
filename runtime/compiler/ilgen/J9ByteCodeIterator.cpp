...
void
TR_J9ByteCodeIterator::printByteCodePrologue(OMR::Logger *log)
   {
   log->prints("\n"
      "        +------------- Byte Code Index\n"
      "        |  +-------------------- OpCode\n"
...
void
TR_J9ByteCodeIterator::printByteCodeEpilogue(OMR::Logger *log)
   {
   log->prints("\n\n");
...
void
TR_J9ByteCodeIterator::printFirst(OMR::Logger *log, int32_t i)
   {
   log->printf("%5i", i);
   }

void
TR_J9ByteCodeIterator::printCPIndex(OMR::Logger *log, int32_t i)
   {
   log->printf("%13s%5i", "", i);
   }

void
TR_J9ByteCodeIterator::printConstant(OMR::Logger *log, int32_t i)
   {
   log->printf("%11s%12i  ", "", i);
   }

void
TR_J9ByteCodeIterator::printConstant(OMR::Logger *log, double d)
   {
   log->printf("%11s%12e  ", "", d);
   }

void
TR_J9ByteCodeIterator::printFirstAndConstant(OMR::Logger *log, int32_t i, int32_t j)
   {
   log->printf("%5i%6s%12i  ", i, "", j);
   }

void
TR_J9ByteCodeIterator::printJumpIndex(OMR::Logger *log, int32_t offset)
   {
   log->printf("%5i,%5d,%11s ", offset, offset + bcIndex(), "");
   }

void
TR_J9ByteCodeIterator::printByteCode(OMR::Logger *log)
   {
