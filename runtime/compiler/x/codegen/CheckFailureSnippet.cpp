...
void
TR_Debug::print(OMR::Logger *log, TR::X86CheckFailureSnippet *snippet)
   {
...
void
TR_Debug::print(OMR::Logger *log, TR::X86BoundCheckWithSpineCheckSnippet *snippet)
   {
   TR::SymbolReference *symRef = snippet->getDestination();
   TR::MethodSymbol *sym = symRef->getSymbol()->castToMethodSymbol();
...
void
TR_Debug::print(OMR::Logger *log, TR::X86SpineCheckSnippet *snippet)
   {
   TR::SymbolReference *symRef = snippet->getDestination();
   TR::MethodSymbol *sym = symRef->getSymbol()->castToMethodSymbol();
...
void
TR_Debug::print(OMR::Logger *log, TR::X86CheckFailureSnippetWithResolve *snippet)
   {
