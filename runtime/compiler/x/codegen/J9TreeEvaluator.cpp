...
static TR::Register* inlineIntrinsicStringIndexOfString(TR::Node* node, TR::CodeGenerator* cg, bool isLatin1)
   ...
   generateRegMemInstruction(TR::InstOpCode::MOVUPSRegMem, node, xmmReg1, generateX86MemoryReference(tmpReg, 0, cg), cg);
   ...
   generateRegMemInstruction(TR::InstOpCode::MOVUPSRegMem, node, xmmReg1, generateX86MemoryReference(s1Reg, resultReg, shift, hdrSize, cg), cg);
   generateRegRegInstruction(compareOp, node, xmmReg1, xmmReg2, cg);
   generateRegRegInstruction(TR::InstOpCode::PMOVMSKB4RegReg, node, tmpReg, xmmReg1, cg);
   generateRegRegInstruction(TR::InstOpCode::TEST4RegReg, node, tmpReg, tmpReg, cg);
   generateLabelInstruction(TR::InstOpCode::JNE1, node, firstCharMatchedLabel, cg);
   ...
   generateRegMemInstruction(TR::InstOpCode::MOVUPSRegMem, node, xmmReg1, generateX86MemoryReference(s1addrReg, s2idxReg, shift, 0, cg), cg);
   generateRegMemInstruction(TR::InstOpCode::MOVUPSRegMem, node, xmmReg3, generateX86MemoryReference(s2Reg, s2idxReg, shift, hdrSize, cg), cg);
