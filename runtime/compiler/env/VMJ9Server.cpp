...
#if defined(JITSERVER_TODO) // Missing TR_ResolvedJ9JITaaSServerMethodInfo
...
TR_J9ServerVM::getSuperClass(TR_OpaqueClassBlock *clazz)
   ...
   JITServer::ServerStream *stream = _compInfoPT->getMethodBeingCompiled()->_stream;
#if defined(JITSERVER_TODO) // Missing JITServerHelpers
...
#if defined(JITSERVER_TODO) // Missing TR_J9Method ctor 
TR::Method *
...
TR_J9ServerVM::createResolvedMethodWithSignature(TR_Memory * trMemory, TR_OpaqueMethodBlock * aMethod, TR_OpaqueClassBlock *classForNewInstance,
   ...
   if (isAOT_DEPRECATED_DO_NOT_USE())
...
#if defined(JITSERVER_TODO) // Missing TR_ResolvedRelocatableJ9JITaaSServerMethod
      ...
      {
#if defined(JITSERVER_TODO) // Missing TR_ResolvedJ9JITaaSServerMethodo
...
*/
#if defined(JITSERVER_TODO) // Missing ClassLoaderStringPair
TR_OpaqueClassBlock *
...
TR_J9ServerVM::isMethodTracingEnabled(TR_OpaqueMethodBlock *method)
   {
#if defined(JITSERVER_TODO) // Missing getClientData
      {
...
#if defined(JITSERVER_TODO) // Missing TR_ResolvedJ9JITaaSServerMethod
bool
...
TR_J9ServerVM::isClassInitialized(TR_OpaqueClassBlock * clazz)
   ...
   JITServer::ServerStream *stream = _compInfoPT->getMethodBeingCompiled()->_stream;
#if defined(JITSERVER_TODO) // Missing JITServerHelpers and getClientData
...
#if defined(JITSERVER_TODO) // Missing TR_ResolvedJ9JITaaSServerMethod, JITServerHelpers, getClientData
bool
...
#if defined(JITSERVER_TODO) // Missing TR_J2IThunk
void
...
#if defined(JITSERVER_TODO) // Missing ClassLoaderStringPair and TR_ResolvedRelocatableJ9JITaaSServerMethod
TR_OpaqueClassBlock *
