...
struct TR_ResolvedJ9JITServerMethodInfoStruct {
...
// The last 3 strings are serialized versions of jittedBodyInfo, persistentMethodInfo and
// TR_ContiguousIPMethodHashTableInfo
using TR_ResolvedJ9JITServerMethodInfo
    = std::tuple<TR_ResolvedJ9JITServerMethodInfoStruct, std::string, std::string, std::string>;
...
struct TR_ResolvedMethodKey {
    ...
    {
        return type == other.type && ramClass == other.ramClass && cpIndex == other.cpIndex
...
template<> struct hash<TR_ResolvedMethodKey> {
    std::size_t operator()(const TR_ResolvedMethodKey &k) const
    {
        ...
        return std::hash<int32_t>()(static_cast<int32_t>(k.type)) ^ std::hash<TR_OpaqueClassBlock *>()(k.ramClass)
            ^ std::hash<int32_t>()(k.cpIndex) ^ std::hash<TR_OpaqueClassBlock *>()(k.classObject);
    }
};
} // namespace std
...
public:
    TR_ResolvedJ9JITServerMethod(TR_OpaqueMethodBlock *aMethod, TR_FrontEnd *, TR_Memory *,
        TR_ResolvedMethod *owningMethod = 0, uint32_t vTableSlot = 0);
    TR_ResolvedJ9JITServerMethod(TR_OpaqueMethodBlock *aMethod, TR_FrontEnd *, TR_Memory *,
        const TR_ResolvedJ9JITServerMethodInfo &methodInfo, TR_ResolvedMethod *owningMethod = 0,
    ...
    virtual TR_ResolvedMethod *getResolvedPossiblyPrivateVirtualMethod(TR::Compilation *, int32_t cpIndex,
        bool ignoreRtResolve, bool *unresolvedInCP) override;
    virtual TR_ResolvedMethod *getResolvedStaticMethod(TR::Compilation *comp, I_32 cpIndex,
        bool *unresolvedInCP) override;
    virtual TR_ResolvedMethod *getResolvedSpecialMethod(TR::Compilation *comp, I_32 cpIndex,
        bool *unresolvedInCP) override;
    virtual TR_ResolvedMethod *createResolvedMethodFromJ9Method(TR::Compilation *comp, int32_t cpIndex,
        uint32_t vTableSlot, J9Method *j9Method, TR_AOTInliningStats *aotStats) override;
    virtual TR_ResolvedMethod *createResolvedMethodFromJ9Method(TR::Compilation *comp, int32_t cpIndex,
    ...
    virtual bool fieldAttributes(TR::Compilation *, int32_t cpIndex, uint32_t *fieldOffset, TR::DataType *type,
        bool *volatileP, bool *isFinal, bool *isPrivate, bool isStore, bool *unresolvedInCP,
        bool needsAOTValidation) override;
    ...
    virtual TR_ResolvedMethod *getResolvedVirtualMethod(TR::Compilation *comp, TR_OpaqueClassBlock *classObject,
        I_32 virtualCallOffset, bool ignoreRtResolve) override;
    ...
    static void createResolvedMethodMirror(TR_ResolvedJ9JITServerMethodInfo &methodInfo, TR_OpaqueMethodBlock *method,
        uint32_t vTableSlot, TR_ResolvedMethod *owningMethod, TR_FrontEnd *fe, TR_Memory *trMemory);
    static void createResolvedMethodFromJ9MethodMirror(TR_ResolvedJ9JITServerMethodInfo &methodInfo,
    ...
    void cacheFields();
    int32_t collectImplementorsCapped(TR_OpaqueClassBlock *topClass, int32_t maxCount, int32_t cpIndexOrOffset,
        TR_YesNoMaybe useGetResolvedInterfaceMethod, TR_ResolvedMethod **implArray);

    bool isLambdaFormGeneratedMethod() { return _isLambdaFormGeneratedMethod; }

    static void packMethodInfo(TR_ResolvedJ9JITServerMethodInfo &methodInfo, TR_ResolvedJ9Method *resolvedMethod,
        TR_FrontEnd *fe);
    static void getClientBondMethodsToSendToServer(TR::Compilation *comp, std::vector<TR_ClientBondMethod> &dest);

protected:
    JITServer::ServerStream *_stream;
    J9Class *_ramClass; // client pointer to RAM class
    static void setAttributeResultFromResolvedMethodFieldAttributes(const TR_J9MethodFieldAttributes &attributes,
        U_32 *fieldOffset, void **address, TR::DataType *type, bool *volatileP, bool *isFinal, bool *isPrivate,
        bool *unresolvedInCP, bool *result, bool isStatic);
    ...
    virtual bool validateMethodFieldAttributes(const TR_J9MethodFieldAttributes &attributes, bool isStatic,
        int32_t cpIndex, bool isStore, bool needAOTValidation);
...
public:
    TR_ResolvedRelocatableJ9JITServerMethod(TR_OpaqueMethodBlock *aMethod, TR_FrontEnd *, TR_Memory *,
        TR_ResolvedMethod *owningMethod = 0, uint32_t vTableSlot = 0);
    TR_ResolvedRelocatableJ9JITServerMethod(TR_OpaqueMethodBlock *aMethod, TR_FrontEnd *, TR_Memory *,
        const TR_ResolvedJ9JITServerMethodInfo &methodInfo, TR_ResolvedMethod *owningMethod = 0,
        uint32_t vTableSlot = 0);
    ...
    virtual bool validateClassFromConstantPool(TR::Compilation *comp, J9Class *clazz, uint32_t cpIndex,
        TR_ExternalRelocationTargetKind reloKind = TR_ValidateClass) override;
    ...
    virtual bool fieldAttributes(TR::Compilation *comp, int32_t cpIndex, uint32_t *fieldOffset, TR::DataType *type,
        bool *volatileP, bool *isFinal, bool *isPrivate, bool isStore, bool *unresolvedInCP,
        bool needAOTValidation) override;
    virtual bool staticAttributes(TR::Compilation *comp, int32_t cpIndex, void **address, TR::DataType *type,
        bool *volatileP, bool *isFinal, bool *isPrivate, bool isStore, bool *unresolvedInCP,
        bool needAOTValidation) override;
    virtual TR_ResolvedMethod *getResolvedImproperInterfaceMethod(TR::Compilation *comp, I_32 cpIndex) override;
    ...
    virtual TR_OpaqueClassBlock *getDeclaringClassFromFieldOrStatic(TR::Compilation *comp, int32_t cpIndex) override;
    bool storeValidationRecordIfNecessary(TR::Compilation *comp, J9ConstantPool *constantPool, int32_t cpIndex,
...
protected:
    ...
    virtual TR_ResolvedMethod *createResolvedMethodFromJ9Method(TR::Compilation *comp, int32_t cpIndex,
        uint32_t vTableSlot, J9Method *j9Method, TR_AOTInliningStats *aotStats,
        const TR_ResolvedJ9JITServerMethodInfo &methodInfo) override;
    ...
    virtual bool validateMethodFieldAttributes(const TR_J9MethodFieldAttributes &attributes, bool isStatic,
        int32_t cpIndex, bool isStore, bool needAOTValidation) override;
