    ...
    TR::Register *scratchReg1, TR::Register *scratchReg2, TR::Register *scratchReg3)
{
    ...
    Inst_Label(cg(), callNode, loopHead);
    ...
    Inst_Label(cg(), callNode, releaseVMAccessRestartLabel);
}
    ...
    TR::Register *scratchReg1, TR::Register *scratchReg2)
{
    ...
    Inst_Label(cg(), callNode, reacquireVMAccessRestartLabel);
}
    ...
    TR::Register *javaStackReg, TR::Register *scratchReg)
{
    ...
    if (tearDownJNIFrame) {
        ...
        Inst_Label(cg(), callNode, refPoolRestartLabel);
    }
    ...
    switch (resolvedMethod->returnType()) {
        case TR::Address:
            if (wrapRefs) {
                ...
                Inst_Label(cg(), callNode, tempLabel);
            }
            break;
        case TR::Int8:
...
TR::Register *J9::ARM64::JNILinkage::buildDirectDispatch(TR::Node *callNode)
{
    ...
    Inst_Label(cg(), callNode, returnLabel, callInstr);
    ...
    Inst_Label(cg(), callNode, depLabel, postLabelDeps);
