...
static TR::Register *inlineIntrinsicStringIndexOfString(TR::Node *node, TR::CodeGenerator *cg, bool isLatin1)
   ...
   if (isLatin1)
      {
      generateTrg1MemInstruction(cg, TR::InstOpCode::ldrbimm, node, tmp1Reg, TR::MemoryReference::createWithIndexReg(cg, tmp3Reg, s2idxReg));
      ...
      generateTrg1MemInstruction(cg, TR::InstOpCode::ldrhimm, node, tmp1Reg, TR::MemoryReference::createWithIndexReg(cg, tmp3Reg, tmp2Reg));
