...
#include "codegen/OMRRecognizedMethodsEnum.hpp"
   ...
   jdk_internal_misc_Unsafe_getAndAddByte,
   jdk_internal_misc_Unsafe_getAndSetByte,
   jdk_internal_misc_Unsafe_getAndAddShort,
   jdk_internal_misc_Unsafe_getAndSetShort,
