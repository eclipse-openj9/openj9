...
FirstJ9Method = LastOMRMethod + 1,
    ...
    java_lang_StringLatin1_charAt, java_lang_StringLatin1_compareTo_BBII, java_lang_StringLatin1_indexOf,
    java_lang_StringLatin1_indexOf_BB, java_lang_StringLatin1_indexOf_BIII, java_lang_StringLatin1_indexOfChar,
    java_lang_StringLatin1_inflate_BIBII, java_lang_StringLatin1_inflate_BICII, java_lang_StringLatin1_lastIndexOf,
    java_lang_StringLatin1_newString, java_lang_StringLatin1_replace_char, java_lang_StringLatin1_replace_CharSequence,
    java_lang_StringLatin1_toBytes, java_lang_StringLatin1_toChars, java_lang_StringLatin1_toLowerCase,
    java_lang_StringLatin1_toUpperCase, java_lang_StringLatin1_trim,
    ...
    jdk_internal_misc_Unsafe_setMemory0, jdk_internal_misc_Unsafe_getShortUnaligned,
    jdk_internal_misc_Unsafe_getIntUnaligned, jdk_internal_misc_Unsafe_getLongUnaligned,
    jdk_internal_misc_Unsafe_putCharUnaligned, jdk_internal_misc_Unsafe_putShortUnaligned,
    jdk_internal_misc_Unsafe_putIntUnaligned, jdk_internal_misc_Unsafe_putLongUnaligned,
    jdk_internal_loader_NativeLibraries_load, jdk_internal_util_ArraysSupport_vectorizedMismatch,
    jdk_internal_util_ArraysSupport_vectorizedHashCode, jdk_internal_util_Preconditions_checkIndex,
