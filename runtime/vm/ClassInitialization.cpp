...
initFailed:
				...
				if (clazz->strictStaticFieldCounter > 0) {
					...
					setCurrentExceptionNLSWithArgs(currentThread, J9NLS_VM_CLASS_LOADING_ERROR_STRICT_STATIC_FIELDS_UNSET, J9VMCONSTANTPOOL_JAVALANGILLEGALSTATEEXCEPTION, J9UTF8_DATA(className));
					goto initFailed;
				}
