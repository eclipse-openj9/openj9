...
static VMINLINE BOOLEAN checkSuperClassAndInterfaces(J9VMThread *vmThread, J9ClassLoader *classLoader, J9ROMClass *romClass, UDATA options, UDATA packageID, BOOLEAN hotswapping, J9Class *superclass, J9Module *module, J9ROMClass **badClassOut, bool *incompatibleOut, J9Class **interfaceClassOut, UDATA *illegalAccessErrorTypes);
...
checkSuperClassAndInterfaces(J9VMThread *vmThread, J9ClassLoader *classLoader, J9ROMClass *romClass, UDATA options,
	...
	J9Class **interfaceClassOut, UDATA *illegalAccessErrorTypes)
{
#if JAVA_SPEC_VERSION >= 11
	J9JavaVM *vm = vmThread->javaVM;
#endif /* JAVA_SPEC_VERSION >= 11 */
...
fail:
	...
	/* default value is -1, 0 is superclass, and 1 is superinterface */
	UDATA illegalAccessErrorTypes = ILLEGAL_ACCESS_OTHERS;
