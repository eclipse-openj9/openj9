...
public:
	...
	U_32 getMonitorWaitCount()
	{
		return _monitorWaitCount;
	}

	U_32 getCPULoadCount()
	{
		return _cpuLoadCount;
	}

	U_32 getThreadCPULoadCount()
	{
		return _threadCPULoadCount;
	}

	U_32 getClassLoadingStatisticsCount()
	{
