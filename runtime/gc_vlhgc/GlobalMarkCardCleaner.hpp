...
#if !defined(GLOBALMARKCARDCLEANER_HPP_)
#define GLOBALMARKCARDCLEANER_HPP_
...
class MM_GlobalMarkCardCleaner : public MM_CardCleaner 
{
	/* Data Members */
private:
	MM_GlobalMarkingScheme * const _markingScheme;	/**< The marking scheme to use for scanning objects which have been modified since they were last scanned */
protected:
public:
...
public:	
	 ...
	 */
	MM_GlobalMarkCardCleaner(MM_GlobalMarkingScheme *markingScheme, MM_HeapMap *map)
		: MM_CardCleaner()
...
#endif /* GLOBALMARKCARDCLEANER_HPP_ */
