...
#if !defined(GLOBALCOLLECTIONCARDCLEANER_HPP_)
#define GLOBALCOLLECTIONCARDCLEANER_HPP_
...
class MM_GlobalCollectionCardCleaner : public MM_CardCleaner 
{
	/* Data Members */
private:
...
public:	
	 ...
	 */
	MM_GlobalCollectionCardCleaner(MM_GlobalMarkingScheme *markingScheme)
		: MM_CardCleaner()
...
#endif /* GLOBALCOLLECTIONCARDCLEANER_HPP_ */
