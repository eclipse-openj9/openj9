...
#if !defined(PARTIALMARKNOGMPCARDCLEANER_HPP_)
#define PARTIALMARKNOGMPCARDCLEANER_HPP_
...
class MM_PartialMarkNoGMPCardCleaner : public MM_CardCleaner 
{
	/* Data Members */
private:
...
public:	
	 ...
	 */
	MM_PartialMarkNoGMPCardCleaner(MM_PartialMarkingScheme *markingScheme)
		: MM_CardCleaner()
...
#endif /* PARTIALMARKNOGMPCARDCLEANER_HPP_ */
