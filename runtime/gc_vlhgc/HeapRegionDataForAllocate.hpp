...
public:
	...
	MM_HeapRegionDescriptorVLHGC *popRegionFromLeafRegionList(MM_EnvironmentVLHGC *env, MM_HeapRegionDescriptorVLHGC **head);
	void pushRegionToLeafRegionList(MM_EnvironmentVLHGC *env, MM_HeapRegionDescriptorVLHGC **head);
