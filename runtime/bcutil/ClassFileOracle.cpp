...
/* Nestmates allow invokeVirtual on private methods from nestmate class, these virtual method have to be placed in the vTable */
#if defined(J9VM_OPT_VALHALLA_NESTMATES)
	/* static methods are never virtual */
	if (0 != (_classFile->methods[methodIndex].accessFlags & (CFR_ACC_STATIC))) {
#else
