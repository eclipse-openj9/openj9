...
#undef J9WRONGNAME
				...
				if ((NULL != _javaVM) && (NULL != J9_VM_FUNCTION_VIA_JAVAVM(_javaVM, hashClassTableAt)(_classLoader, className, classNameLength, J9_HASH_TABLE_LOOKUP_FLAG_JCL_DEFINE_CLASS))) {
					PORT_ACCESS_FROM_PORT(_portLibrary);
