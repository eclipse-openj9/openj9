...
#define VMOPT_VTENABLEARRAYFLATTENING "-XX:+EnableArrayFlattening"
#define VMOPT_VTDISABLEARRAYFLATTENING "-XX:-EnableArrayFlattening"
...
#define VMOPT_XXENABLEOPENJ9EXPERIMENTALFLIGHTRECORDING "-XX:+EnableOpenJ9ExperimentalFlightRecording"
#define VMOPT_XXDISABLEOPENJ9EXPERIMENTALFLIGHTRECORDING "-XX:-EnableOpenJ9ExperimentalFlightRecording"
