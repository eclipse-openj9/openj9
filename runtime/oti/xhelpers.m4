...
dnl No FP parameter registers
	...
	mov eax,dword ptr J9TR_VMThread_javaVM[J9VMTHREAD]
	mov eax,dword ptr J9TR_JavaVM_extendedRuntimeFlags3[eax]
	test eax,(J9TR_J9_EXTENDED_RUNTIME3_USE_VECTOR_LENGTH_256 | J9TR_J9_EXTENDED_RUNTIME3_USE_VECTOR_LENGTH_512)
	jz LABEL(L_xmm_save{}SYM_COUNT)

	dnl save YMM/ZMM registers (out-of-line)
	LABEL(L_ool_save{}SYM_COUNT):

	mov eax,J9TR_VMThread_javaVM[J9VMTHREAD]
	mov eax,J9TR_JavaVMJitConfig[eax]
	mov eax,J9TR_JitConfig_saveVectorRegisters[eax]
	call eax
...
dnl No FP parameter registers
	...
	mov eax,J9TR_VMThread_javaVM[J9VMTHREAD]
	mov eax,J9TR_JavaVMJitConfig[eax]
	mov eax,J9TR_JitConfig_restoreVectorRegisters[eax]
	call eax
