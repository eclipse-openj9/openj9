...
/**
 * Walks the JavaLauncherOptionTable to find the entry for a given argument.
 * The entries in this table represent arguments that are generated by the Java Launcher in OpenJDK.
 * @param optionName is the argument whe are looking for in JavaLauncherOptionTable.
