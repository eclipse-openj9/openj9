 ...
 * @{
 */
#define J9PORT_ERROR_SYSV_IPC_FTOK_ERROR ((U_32)-2 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SEMGET_ERROR ((U_32)-3 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SEMCTL_ERROR ((U_32)-4 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SEMOP_ERROR ((U_32)-5 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SHMGET_ERROR ((U_32)-6 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SHMCTL_ERROR ((U_32)-7 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SHMAT_ERROR ((U_32)-8 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_SHMDT_ERROR ((U_32)-9 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
#define J9PORT_ERROR_SYSV_IPC_GETIPC_ERROR ((U_32)-10 << J9PORT_ERROR_SYSTEM_CALL_CODE_SHIFT)
