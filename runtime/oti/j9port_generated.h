...
typedef struct J9PortLibrary {
	...
	int32_t ( *sysinfo_cgroup_subsystem_iterator_init)(struct J9PortLibrary *portLibrary, uint64_t subsystem, J9CgroupMetricIteratorState *state);
	/** see @ref j9sysinfo.c::j9sysinfo_cgroup_subsystem_iterator_hasNext "j9sysinfo_cgroup_subsystem_iterator_hasNext"*/
	BOOLEAN ( *sysinfo_cgroup_subsystem_iterator_hasNext)(struct J9PortLibrary *portLibrary, J9CgroupMetricIteratorState *state);
	/** see @ref j9sysinfo.c::j9sysinfo_cgroup_subsystem_iterator_next "j9sysinfo_cgroup_subsystem_iterator_next"*/
	int32_t ( *sysinfo_cgroup_subsystem_iterator_next)(struct J9PortLibrary *portLibrary, J9CgroupMetricIteratorState *state, J9CgroupMetricElement *cgroupElement);
...
#define j9sysinfo_cgroup_subsystem_iterator_next(param1,param2) privatePortLibrary->sysinfo_cgroup_subsystem_iterator_next(privatePortLibrary,param1,param2)
