...
#define J9_SUN_ISOLATED_FIELD_OFFSET_TAG 0x2
...
#define J9_RESOLVE_FLAG_SEARCH_INTERFACES 0x2
...
#define J9_JAVA_CLASS_NEEDS_PER_TENANT_INITIALIZATION 0x1000000
...
#define J9_JAVA_FIELD_HAS_TENANT_ANNOTATION 0x10000000
...
#define J9_RUNTIME_UNUSED_0x10000000 0x10000000
...
#define J9_EXTENDED_RUNTIME_UNUSED_0x40000000 0x40000000
...
#define J9_STACKWALK_CACHE_MASK 0x300
...
#define J9_FINDCLASS_FLAG_DERIVED_VALUE_TYPE 0x10000
...
#define J9_GC_WRITE_BARRIER_TYPE_REALTIME OMR_GC_WRITE_BARRIER_TYPE_REALTIME
...
#define J9_GC_READ_BARRIER_TYPE_EVACUATE OMR_GC_READ_BARRIER_TYPE_EVACUATE
...
/* 8 * sizeof(fj9object_t) */
#if defined(J9VM_ENV_DATA64) && !defined(J9VM_GC_COMPRESSED_POINTERS)
#define J9_GC_OBJECT_HEAP_TAIL_PADDING 0x40
#else /* J9VM_ENV_DATA64 && !J9VM_GC_COMPRESSED_POINTERS */
#define J9_GC_OBJECT_HEAP_TAIL_PADDING 0x20
#endif /* J9VM_ENV_DATA64 && !J9VM_GC_COMPRESSED_POINTERS */
#else /* J9VM_ARCH_S390 */
#define J9_GC_OBJECT_HEAP_TAIL_PADDING 0x0
#endif /* J9VM_ARCH_S390 */
...
#define J9_JVMTI_METHOD_SELECTIVE_ENTRY_EXIT 0x10
...
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_METHOD_ENTRY_EXTENDED				0x39
#if defined (J9VM_INTERP_NATIVE_SUPPORT)
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_COMPILING_START					0x3A
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_COMPILING_END						0x3B
#endif
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_INSTRUMENTABLE_OBJECT_ALLOC		0x3C
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_VM_DUMP_START						0x3D
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_VM_DUMP_END						0x3E
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_EVENT_ASYNC						0x3F
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_METHOD_EXIT_NO_RC					0x40
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_GC_CYCLE_START					0x41
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_GC_CYCLE_FINISH					0x42
#define J9_JNI_OFFLOAD_SWITCH_J9JVMTI_ARRAY_CLASS_LOAD					0x43
/* 0x44 to 0x4F Reserved for JVMTI events */
#define J9_JNI_OFFLOAD_SWITCH_TRACE_SUBSCRIBER_THREAD					0x50
