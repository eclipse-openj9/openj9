...
#define J9JVMTI_WATCHED_FIELD_ACCESS_BITS_PER_FIELD ((UDATA)2)
#define J9JVMTI_WATCHED_FIELDS_PER_UDATA \
	((sizeof(UDATA) * 8) / J9JVMTI_WATCHED_FIELD_ACCESS_BITS_PER_FIELD)
...
#define J9JVMTI_WATCHED_FIELD_ARRAY_INDEX(index) \
	(((UDATA)(index)) / J9JVMTI_WATCHED_FIELDS_PER_UDATA)
#define J9JVMTI_WATCHED_FIELD_ACCESS_BIT(index) \
	(((UDATA)1) << ((((UDATA)(index)) * J9JVMTI_WATCHED_FIELD_ACCESS_BITS_PER_FIELD) % J9JVMTI_WATCHED_FIELDS_PER_UDATA))
