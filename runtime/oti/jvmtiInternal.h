...
#if defined(J9_JVMTI_PERFORM_CHECKS)
...
#else /* defined(J9_JVMTI_PERFORM_CHECKS) */
...
#endif /* defined(J9_JVMTI_PERFORM_CHECKS) */
...
#if JAVA_SPEC_VERSION >= 19
/* These macros corresponds to the states in java.lang.VirtualThread. */
