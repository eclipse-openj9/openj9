...
#define J9_LOWEST_STACK_SLOT(vmThread) ((J9_ARE_ALL_BITS_SET((vmThread)->javaVM->extendedRuntimeFlags3, J9_EXTENDED_RUNTIME3_JAVA_STACK_GUARD_PAGES)) ? (UDATA *)((UDATA)(vmThread)->stackObject->guardPage + (vmThread)->javaVM->defaultPageSize) : (UDATA *) ((vmThread)->stackObject + 1))
