...
#define J9_STATIC_FIELD_STRICT_INIT_IS_UNSET(classAndFlags) \
    J9_ARE_ALL_BITS_SET(classAndFlags, J9StaticFieldRefStrictInitUnset)
#define J9_STATIC_FIELD_STRICT_INIT_WAS_WRITTEN_AND_READ(classAndFlags) \
    (J9StaticFieldRefStrictInitRead == ((classAndFlags) & J9StaticFieldRefStrictInitUnset))
#define J9_STATIC_FIELD_STRICT_INIT_WAS_WRITTEN(classAndFlags) \
    (J9StaticFieldRefStrictInitWritten == ((classAndFlags) & J9StaticFieldRefStrictInitUnset))
