...
#if defined(J9VM_OPT_VALHALLA_VALUE_TYPES)
#define CFR_ACC_FLATTENABLE					0x00000100
#endif /* defined(J9VM_OPT_VALHALLA_VALUE_TYPES) */
...
#if defined(J9VM_OPT_VALHALLA_VALUE_TYPES)
#define CFR_FIELD_ACCESS_MASK  					(CFR_ACC_PUBLIC | CFR_ACC_PRIVATE | CFR_ACC_PROTECTED | CFR_ACC_STATIC | CFR_ACC_FINAL | CFR_ACC_VOLATILE | CFR_ACC_TRANSIENT | CFR_ACC_SYNTHETIC | CFR_ACC_ENUM | CFR_ACC_FLATTENABLE)
#else /* defined(J9VM_OPT_VALHALLA_VALUE_TYPES) */
