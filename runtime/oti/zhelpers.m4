...
define({FPRS_8_TO_15_NONVOLATILE})
})
ifdef({J9ZOS390},{
define({FPRS_0_TO_7_VOLATILE})
define({FPRS_8_TO_15_NONVOLATILE})
...
ifdef({FPRS_8_TO_15_NONVOLATILE},{
define({SAVE_C_NONVOLATILE_FPRS},{
...
define({RESTORE_C_NONVOLATILE_FPRS},{
...
define({SAVE_C_NONVOLATILE_VRS},{
    VSTM(16, 23, JIT_VR_SAVE_OFFSET(16), CSP)
})
define({RESTORE_C_NONVOLATILE_VRS},{
    VLDM(16, 23, JIT_VR_SAVE_OFFSET(16), CSP)
})
define({SAVE_C_NONVOLATILE_FPRVR},{
    ...
    nr r9,r8
    jz LABEL_NAME(CONCAT(L_SK,SYM_COUNT))
    SAVE_C_NONVOLATILE_VRS
PLACE_LABEL(CONCAT(L_SK,SYM_COUNT))
    SAVE_C_NONVOLATILE_FPRS
})
define({RESTORE_C_NONVOLATILE_FPRVR},{
    L_GPR r8,J9TR_VMThread_javaVM(J9VMTHREAD)
    l r8,J9TR_JavaVM_extendedRuntimeFlags(r8)
    lhi r9,J9TR_J9_EXTENDED_RUNTIME_USE_VECTOR_REGISTERS
    nr r9,r8
    jz LABEL_NAME(CONCAT(L_RK,SYM_COUNT))
    RESTORE_C_NONVOLATILE_VRS
PLACE_LABEL(CONCAT(L_RK,SYM_COUNT))
    RESTORE_C_NONVOLATILE_FPRS
})
},{
define({SAVE_C_VOLATILE_VRS},{
    VSTM(0, 15, JIT_VR_SAVE_OFFSET(0), CSP)
