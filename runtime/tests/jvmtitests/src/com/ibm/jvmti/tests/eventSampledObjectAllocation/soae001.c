...
void JNICALL
Java_com_ibm_jvmti_tests_eventSampledObjectAllocation_soae001_reset(JNIEnv *jni_env, jclass cls)
{
	soaeResult = 0;
}

jint JNICALL
Java_com_ibm_jvmti_tests_eventSampledObjectAllocation_soae001_enable(JNIEnv *jni_env, jclass cls)
{
	jint result = JNI_OK;
	jvmtiError err = JVMTI_ERROR_NONE;
...
jint JNICALL
Java_com_ibm_jvmti_tests_eventSampledObjectAllocation_soae001_disable(JNIEnv *jni_env, jclass cls)
{
	jint result = JNI_OK;
	jvmtiError err = JVMTI_ERROR_NONE;
	JVMTI_ACCESS_FROM_AGENT(env);
...
jint JNICALL
Java_com_ibm_jvmti_tests_eventSampledObjectAllocation_soae001_check(JNIEnv *jni_env, jclass cls)
{
	return soaeResult;
}
