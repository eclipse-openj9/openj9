...
jint JNICALL
rc021(agentEnv *agent_env, char *args)
{
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc021_redefineClass(JNIEnv *jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
	JVMTI_ACCESS_FROM_AGENT(env);
	jbyte *class_bytes = NULL;
