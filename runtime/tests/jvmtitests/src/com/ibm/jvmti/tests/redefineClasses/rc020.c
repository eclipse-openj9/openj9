...
jint JNICALL
rc020(agentEnv * agent_env, char * args)
{
...
jboolean JNICALL
Java_com_ibm_jvmti_tests_redefineClasses_rc020_redefineClass(JNIEnv * jni_env, jclass klass, jclass originalClass, jint classBytesSize, jbyteArray classBytes)
{
