...
#else /* (defined(__IBMCPP__) || defined(__IBMC__) && !defined(MVS)) && !defined(J9ZOS390) && !defined(LINUXPPC64) */
...
#elif defined(MVS) || defined(LINUX) || defined(J9ZOS390) || defined (J9HAMMER) || defined (WIN32) || defined (WIN64)
#define JIT_HELPER(x) extern "C" void x()
#else
#define JIT_HELPER(x) extern "C" x()
#endif /* defined(LINUXPPC64) */

#endif /* (defined(__IBMCPP__) || defined(__IBMC__) && !defined(MVS)) && !defined(J9ZOS390) && !defined(LINUXPPC64) */
...
JIT_HELPER(jitNewObjectNoTenantInit);  // asm calling-convention helper
