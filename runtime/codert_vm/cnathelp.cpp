...
#if defined(J9VM_ARCH_X86) && defined(J9VM_ENV_DATA64) && (JAVA_SPEC_VERSION >= 17)
...
#endif /* defined(J9VM_ARCH_X86) && defined(J9VM_ENV_DATA64) && (JAVA_SPEC_VERSION >= 17) */
...
old_slow_jitGetFlattenableField(J9VMThread *currentThread)
{
	 ...
	 */
	if ((NULL == returnObject) && J9_ARE_ANY_BITS_SET(cpEntry->flags, J9FieldFlagFlattened)) {
...
old_slow_jitPutFlattenableField(J9VMThread *currentThread)
{
	...
	buildJITResolveFrameForRuntimeHelper(currentThread, parmCount);
	rc = setCurrentExceptionNLSFromJIT(currentThread, J9VMCONSTANTPOOL_JAVALANGNULLPOINTEREXCEPTION, J9NLS_VM_CANNOT_STORE_NULL_IN_NULL_RESTRICTED_ARRAY);
...
old_fast_jitPutFlattenableField(J9VMThread *currentThread)
{
	...
	if ((NULL == paramObject) && J9_ARE_ANY_BITS_SET(cpEntry->flags, J9FieldFlagIsNullRestricted)) {
		goto slow;
	}
