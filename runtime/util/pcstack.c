...
0x10 /* JBiloadw = 203  -- pops: 0 pushes: 1*/ ,
0x20 /* JBlloadw = 204  -- pops: 0 pushes: 2*/ ,
0x10 /* JBfloadw = 205  -- pops: 0 pushes: 1*/ ,
0x20 /* JBdloadw = 206  -- pops: 0 pushes: 2*/ ,
0x50 /* JBaloadw = 207  -- pops: 0 pushes: 1*/ ,
0x01 /* JBistorew = 208  -- pops: 1 pushes: 0*/ ,
0x02 /* JBlstorew = 209  -- pops: 2 pushes: 0*/ ,
0x01 /* JBfstorew = 210  -- pops: 1 pushes: 0*/ ,
0x02 /* JBdstorew = 211  -- pops: 2 pushes: 0*/ ,
0x01 /* JBastorew = 212  -- pops: 1 pushes: 0*/ ,
...
0x00 /* JBunimplemented = 220  -- pops: 0 pushes: 0*/ ,
...
const unsigned char J9BytecodeSlotUseTable[] = {
	...
	0x48 /* JBiloadw (16rCB) <islot><wide><read>*/,
	0x28 /* JBlloadw (16rCC) <dslot><wide><read>*/,
	0x48 /* JBfloadw (16rCD) <islot><wide><read>*/,
	0x28 /* JBdloadw (16rCE) <dslot><wide><read>*/,
	0x88 /* JBaloadw (16rCF) <oslot><wide><read>*/,
	0x58 /* JBistorew (16rD0) <islot><wide><write>*/,
	0x38 /* JBlstorew (16rD1) <dslot><wide><write>*/,
	0x58 /* JBfstorew (16rD2) <islot><wide><write>*/,
	0x38 /* JBdstorew (16rD3) <dslot><wide><write>*/,
	0x98 /* JBastorew (16rD4) <oslot><wide><write>*/,
