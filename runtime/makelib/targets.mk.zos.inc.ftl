...
UMA_ZOS_FLAGS+=-I$(OMR_DIR)/util/a2e/headers $(UMA_OPTIMIZATION_FLAGS) $(UMA_OPTIMIZATION_LINKER_FLAGS) -Wc,xplink,convlit\(ISO8859-1\),rostring,FLOAT\(IEEE,FOLD,AFP\),enum\(4\) -Wa,goff -Wc,NOANSIALIAS -Wc,inline\(auto,noreport,600,5000\)
UMA_ZOS_FLAGS+=-W "c,SERVICE(j${uma.buildinfo.build_date})" -Wc,TARGET\(zOSV1R13\) 
UMA_ZOS_FLAGS+=-W "c,list,offset"
...
SPECIALCXXFLAGS=$(filter-out -O3,$(CXXFLAGS))
