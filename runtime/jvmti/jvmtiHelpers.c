...
static const UDATA reasonCodeFromJVMTIEvent[] = {
	...
	J9_JNI_OFFLOAD_SWITCH_J9JVMTI_METHOD_ENTRY_EXTENDED,				/* J9JVMTI_EVENT_COM_IBM_METHOD_ENTRY_EXTENDED */
	...
	J9_JNI_OFFLOAD_SWITCH_J9JVMTI_EVENT_ASYNC,							/* J9_JNI_OFFLOAD_SWITCH_J9JVMTI_EVENT_ASYNC */
	J9_JNI_OFFLOAD_SWITCH_J9JVMTI_METHOD_EXIT_NO_RC,					/* J9JVMTI_EVENT_COM_IBM_METHOD_EXIT_NO_RC */
	...
	J9_JNI_OFFLOAD_SWITCH_J9JVMTI_ARRAY_CLASS_LOAD						/* J9JVMTI_EVENT_COM_IBM_ARRAY_CLASS_LOAD */
};
...
disposeEnvironment(J9JVMTIEnv * j9env, UDATA freeData)
{
	...
	if ((j9env->flags & J9JVMTIENV_FLAG_DISPOSED) == 0) {
		...
		/* Discard hookable async handler key */
