...
public class FlagStructureList
{
	...
	private static final Set<String> flagsStructures = new HashSet<String>();
	...
	public static boolean isFlagsStructure(String structureName)
	{
		return flagsStructures.contains(structureName);
	}
}
