...
public class BCNames {
	...
	public static final int JBiloadw = 203;
	public static final int JBlloadw = 204;
	public static final int JBfloadw = 205;
	public static final int JBdloadw = 206;
	public static final int JBaloadw = 207;
	public static final int JBistorew = 208;
	public static final int JBlstorew = 209;
	public static final int JBfstorew = 210;
	public static final int JBdstorew = 211;
	public static final int JBastorew = 212;
	...
	public static final int JBretFromNativeD = 247;
	public static final int JBretFromNativeJ = 248;
	public static final int JBldc2dw = 249;
	public static final int JBasyncCheck = 250;
	public static final int JBreturnFromJ2I = 251;
