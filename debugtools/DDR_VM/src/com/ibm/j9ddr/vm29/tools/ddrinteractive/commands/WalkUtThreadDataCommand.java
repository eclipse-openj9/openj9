...
public class WalkUtThreadDataCommand extends Command
{
	public WalkUtThreadDataCommand()
	{
		addCommand("walkutthreaddata", "", "finds and validates all UTThreadData structures");
	}
