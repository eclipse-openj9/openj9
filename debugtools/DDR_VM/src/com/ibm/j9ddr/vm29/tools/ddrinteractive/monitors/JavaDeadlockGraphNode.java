...
public final class JavaDeadlockGraphNode extends NativeDeadlockGraphNode
{
	...
	public boolean equals(Object obj)
	{
		...
		JavaDeadlockGraphNode other = (JavaDeadlockGraphNode) obj;
		return other.javaThread.equals(this.javaThread);
	}
	
	public String toString()
	{
		String retVal = "Thread:\t";
		retVal += javaThread.formatShortInteractive() + " (\"";
		retVal += J9VMThreadHelper.getName(javaThread);
		return retVal + "\")";
	}
