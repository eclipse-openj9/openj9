...
public class U8 extends UScalar {
	...
	public static final U8 MIN = new U8(0x00L);
	public static final U8 MAX = new U8(0xFFL);

	public U8(long value) {
		super(value & MASK);
	}

	public U8(Scalar parameter) {
		super(parameter);
	}
	
	// Add
	
	public U8 add(int number) {
		return new U8(data + number);
	}
	
	public U8 add(U8 parameter) {
		return new U8(data + parameter.data);
	}
	...
	public U8 sub(int number) {
		return new U8(data - number);
	}
	
	public U8 sub(U8 parameter) {
		return new U8(data - parameter.data);
	}
	...
	public U8 bitOr(int number) {
		return new U8(data | number);
	}
	
	public U8 bitOr(long number) {
		return new U8(data | number);
	}
	
	public U8 bitOr(U8 parameter) {
		return new U8(data | parameter.data);
	}
	...
	public U8 bitAnd(int number) {
		return new U8(data & number);
	}
	
	public U8 bitAnd(long number) {
		return new U8(data & number);
	}
	
	public U8 bitAnd(U8 parameter) {
		return new U8(data & parameter.data);
	}
	...
	public U8 mult(int parameter) {
		return new U8(data * parameter);
	}
