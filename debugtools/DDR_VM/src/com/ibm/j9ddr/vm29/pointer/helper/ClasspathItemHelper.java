...
import com.ibm.j9ddr.vm29.structure.ClasspathItem;

public class ClasspathItemHelper {
	//#define CPEI_ARRAY_PTR_FROM_CPI(cpiPtr) (IDATA*)((BlockPtr)cpiPtr + HEADER_SIZE)
	public static IDATAPointer CPEI_ARRAY_PTR_FROM_CPI(ClasspathItemPointer ptr) {
		return IDATAPointer.cast(ptr.addOffset(ClasspathItem.SIZEOF));
	}	
}
