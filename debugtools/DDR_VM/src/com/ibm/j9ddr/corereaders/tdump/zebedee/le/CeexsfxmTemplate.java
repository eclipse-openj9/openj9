...
public final class CeexsfxmTemplate {
    ...
    public static long getSfxm_save_r14(ImageInputStream inputStream, long address) throws IOException {
        inputStream.seek(address + 272);
        return inputStream.readInt();
    }
    public static int getSfxm_save_r14$offset() {
        return 272;
    }
    public static int getSfxm_save_r14$length() {
        return 32;
    }
    ...
    public static long getSfxm_save_r7(ImageInputStream inputStream, long address) throws IOException {
        inputStream.seek(address + 316);
        return inputStream.readInt();
    }
    public static int getSfxm_save_r7$offset() {
        return 316;
    }
    public static int getSfxm_save_r7$length() {
        return 32;
    }
}
