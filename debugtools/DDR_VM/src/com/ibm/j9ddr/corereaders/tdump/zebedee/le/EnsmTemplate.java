...
public final class EnsmTemplate {
    ...
    public static long getEnsm_uheap(ImageInputStream inputStream, long address) throws IOException {
    ...
    public static long getEnsm_aheap(ImageInputStream inputStream, long address) throws IOException {
