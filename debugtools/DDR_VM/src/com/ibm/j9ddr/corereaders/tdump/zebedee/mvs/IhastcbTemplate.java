...
public final class IhastcbTemplate {
    ...
    public static long getStcbweb(ImageInputStream inputStream, long address) throws IOException {
        inputStream.seek(address + 232);
        return inputStream.readUnsignedInt() & 0xffffffffL;
    }
    public static int getStcbweb$offset() {
        return 232;
    }
    public static int getStcbweb$length() {
        return 32;
    }
