...
public final class IkjrbprefixTemplate {

    public static int length() {
        return 64;
    }

    public static long getRbxsb(ImageInputStream inputStream, long address) throws IOException {
        inputStream.seek(address + 32);
        return inputStream.readUnsignedInt() & 0xffffffffL;
    }
    public static int getRbxsb$offset() {
        return 32;
    }
    public static int getRbxsb$length() {
        return 32;
    }
}
