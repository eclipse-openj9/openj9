...
public class JniRegistersIA32 extends JniRegisters 
{
	protected long getInstructionPointer()
	{
		return _registers.get("eip").longValue();
	}
	...
	{
		return _registers.get("esp").longValue();
	}
	
	protected long getBasePointer()
	{
		return _registers.get("ebp").longValue();
	}
}
