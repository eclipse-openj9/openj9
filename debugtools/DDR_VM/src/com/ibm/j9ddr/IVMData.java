...
public interface IVMData {
	/**
	 * Bootstraps into a class by absolute classname
	 */
	public void bootstrap(String classname, Object ...userData) throws ClassNotFoundException;
	
	/**
	 * Bootstraps into a class by classname relative to the versioned package (e.g. com.ibm.j9ddr.vm23)
	 */
	 ...
	 * @return string representation of the VM version
	 */
