...
#   docker build -t=openj9-jdk9 .
#   docker run --name=jdk9 -it openj9-jdk9
...
RUN cd /root \
 && wget https://api.adoptopenjdk.net/openjdk8-openj9/releases/ppc64le_linux/latest/binary -O bootjdk8.tar.gz \
