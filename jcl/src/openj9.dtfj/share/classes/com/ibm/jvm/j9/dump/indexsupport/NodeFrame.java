...
public class NodeFrame extends NodeAbstract
{
	...
	public NodeFrame(JavaThread thread, Attributes attributes)
	{
		//a stack frame in a vmthread
		//<frame method="0x8255a0" pc="0x2ab9e71833" arguments="0x2abff91440" line="374"/>
		long method = _longFromString(attributes.getValue("method"));
		long pc = _longFromString(attributes.getValue("pc"));
		long arguments = _longFromString(attributes.getValue("arguments"));
		int lineNumber = -1;
	...
	public IParserNode nodeToPushAfterStarting(String uri, String localName, String qName, Attributes attributes)
	{
		...
		if (qName.equals("object")) {
			child = new NodeObject(_frame, attributes);
		} else {
