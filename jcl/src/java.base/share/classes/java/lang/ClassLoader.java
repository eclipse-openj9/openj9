...
public abstract class ClassLoader {
	...
	/*[IF (JAVA_SPEC_VERSION > 8) & RAM_CLASS_CACHE_SUPPORT]*/
	private static boolean applicationClassLoaderInited = false;
	/*[ENDIF] (JAVA_SPEC_VERSION > 8) & RAM_CLASS_CACHE_SUPPORT */
...
/*[IF RAM_CLASS_CACHE_SUPPORT] */
	private static boolean isRCPRestoreRun = VM.isRCPRestoreRun();
