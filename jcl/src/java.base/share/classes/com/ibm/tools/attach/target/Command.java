...
public interface Command {
	...
	static final String GET_THREADDUMP = "ATTACH_GETTHREADDUMP"; //$NON-NLS-1$
	static final String GET_COMPILATIONINFO = "ATTACH_GETCOMPILATIONINFO"; //$NON-NLS-1$
	static final String GET_GCINFO = "ATTACH_GETGCINFO"; //$NON-NLS-1$
	static final String GET_CLASSESINFO = "ATTACH_GETCLASSESINFO"; //$NON-NLS-1$
	static final String TRIGGER_JAVADUMP = "ATTACH_GETJAVADUMP"; //$NON-NLS-1$
	static final String TRIGGER_SYSTEMDUMP = "ATTACH_GETHEAPDUMP"; //$NON-NLS-1$
	static final String TRIGGER_HEAPDUMP = "ATTACH_GETSYSTEMDUMP"; //$NON-NLS-1$
	static final String TRIGGER_SNAPDUMP = "ATTACH_GETSNAPDUMP"; //$NON-NLS-1$
}
