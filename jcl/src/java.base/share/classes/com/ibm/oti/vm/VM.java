 ...
 *            J9_CLASSLOADER_TYPE_APP      - application classloader if RAM_CLASS_CACHE_SUPPORT enabled from Java 11
 *            J9_CLASSLOADER_TYPE_OTHERS   - other classloaders, includes application classloader if Java 8
 *                                           or RAM_CLASS_CACHE_SUPPORT is not enabled
...
/**
 * RCP: assign the builtin classloaders in restore run.
 *
 * @param loader
 *            ClassLoader the ClassLoader instance
 * @param id
