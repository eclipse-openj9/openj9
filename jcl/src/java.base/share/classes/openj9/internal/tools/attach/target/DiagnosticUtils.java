...
/*[IF CRAC_SUPPORT | CRIU_SUPPORT]*/
	/**
	 * The system property prefix for the key/value pairs specified via CRIU.checkpoint or JDK.checkpoint.
	 */
...
/*[IF CRAC_SUPPORT]*/
	/**
	 * Generate a checkpoint via CRIUSupport using a compatability name for CRaC enabled JVM.
	 */
...
/*[IF CRIU_SUPPORT]*/
	/**
	 * Generate a checkpoint via CRIUSupport using a compatability name for CRIU enabled JVM.
	 */
...
/* [IF CRAC_SUPPORT | CRIU_SUPPORT] */
	private static DiagnosticProperties parseCheckpointCommands(String diagnosticCommand) {
		DiagnosticProperties result = null;
		String[] parts = diagnosticCommand.split(DIAGNOSTICS_OPTION_SEPARATOR);
		// parts[0] is DIAGNOSTICS_CRIU_CHECKPOINT or DIAGNOSTICS_JDK_CHECKPOINT
		if (parts.length > 1) {
			// the command format: [CRIU|JDK].checkpoint,imageDir=/path/to/cpData,logLevel=4
...
/*[IF CRAC_SUPPORT | CRIU_SUPPORT]*/
	private static final String DIAGNOSTICS_CHECKPOINTJVM_HELP_START = "Produce a JVM checkpoint via CRIUSupport, optionally set system properties.%n"
			+ FORMAT_PREFIX;
	private static final String DIAGNOSTICS_CHECKPOINTJVM_HELP_END = "[,imageDir=/path/to/cpData][,logLevel=4]" + "%n"
...
/*[IF CRAC_SUPPORT]*/
	private static final String DIAGNOSTICS_JDK_CHECKPOINT_HELP = DIAGNOSTICS_CHECKPOINTJVM_HELP_START + DIAGNOSTICS_JDK_CHECKPOINT + DIAGNOSTICS_CHECKPOINTJVM_HELP_END;
/*[ENDIF] CRAC_SUPPORT */

/*[IF CRIU_SUPPORT]*/
	private static final String DIAGNOSTICS_CRIU_CHECKPOINT_HELP = DIAGNOSTICS_CHECKPOINTJVM_HELP_START + DIAGNOSTICS_CRIU_CHECKPOINT + DIAGNOSTICS_CHECKPOINTJVM_HELP_END;
/*[ENDIF] CRIU_SUPPORT */
