...
/**
 * A container class used to keep track of a single {@link BuildSpec} owner. A {@link BuildSpec} might have more then one Owner
 * 
 * @author Maciek Klimkowski
 */
public class Owner extends OMObject {
	String id;
