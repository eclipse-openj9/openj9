...
public class PlatformWindows extends PlatformImplementation {
	...
	private String getFourPosVersionNumber() throws UMAException {
		/* set to internal version number */
		if (null == OPENJDK_VERSION_NUMBER_FOUR_POSITIONS) {
			...
			OPENJDK_VERSION_NUMBER_FOUR_POSITIONS = getMajorVersion() + "." + getMinorVersion() + "."+ buildIdHigh +"." + buildIdLow;
		}
